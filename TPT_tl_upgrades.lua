...
-- gtp1 5
		t["Rhan"][18][1] = "Joon/Shion Yorigami Upgrade|cffffcc00(E)|r - |c00ff0000Master|r";
-- gnam 1
...
-- gnam 10
-- gub1 1
		t["Rhlh"][35][1] = "*아르카나 유닛의 공격력을 6000, Attack Speed를 5% 증가시킵니다.\r\
...
-- gub1 5
-- gub1 6
		t["Rhlh"][40][1] = "*아르카나 유닛의 공격력을 6000, Attack Speed를 8% 증가시킵니다.\r\
*스킬 툴팁에 특정 Upgrade를 받는다고 별도로 명시된 유닛은 \"아르카나 유닛 Upgrade\"의 효과를 받지 않습니다.";
-- gub1 7
-- gub1 8
-- gub1 10
...
-- gef1
-- gub1 1
		t["Rhss"][7][1] = "*Seiran의 Attack Speed를 8% 증가시킵니다.";
-- gar1 2
-- gar1 3
-- gar1 4
-- gar1 5
...
-- gub1 5
-- gub1 6
		t["Rhss"][31][1] = "*Seiran의 Attack Speed를 2% 증가시킵니다.";
-- gub1 7
-- gub1 8
-- gub1 9
-- gub1 10
...
*Seiran의 Attack Speed가 35% 증가합니다.\r\
*Seiran의 공격력이 15,000 증가합니다.";
-- gnam 1
		t["Rhcd"][6][1] = "[전투자극당근]";
-- gef1
-- gef2
...
-- gub1 1
		t["Rhgb"][2][1] = "케이키의 공격력이 15000 , Attack Speed가 12% 증가합니다. 『조형술』들의 데미지가 3% 증가합니다.\r\
\r\
...
-- gtp1 5
		t["Rhgb"][16][1] = "Keiki Haniyasushin Upgrade|cffffcc00(D)|r - |c00ff0000Master|r";
-- gub1 2
-- gub1 3
-- gub1 4
-- gub1 5
...
-- gtp1 5
		t["Rhfc"][17][1] = "Mugetsu Upgrade|cffffcc00(F)|r - |c00ff0000Master|r";
-- gub1 1
		t["Rhfc"][18][1] = "『트라움 샷』에 Current Health 0.01%의 절대 피해가 추가됩니다.\r\
\r\
...
-- gtp1 5
		t["Rhfl"][18][1] = "Reimu Hakurei Upgrade|cffffcc00(Q)|r - |c00ff0000Master|r";
-- gnam 1
...
-- gtp1 5
		t["Rome"][19][1] = "Kotohime Upgrade|cffffcc00(W)|r - |c00ff0000Master|r";
-- gnam 1
...
-- gnam 5
-- gub1 1
		t["Rome"][25][1] = "Kotohime의 Attack Speed를 10% 증가시킵니다.\r\
\r\
...
-- gtp1 5
		t["Roar"][20][1] = "Meira Upgrade|cffffcc00(E)|r - |c00ff0000Master|r";
-- gub1 1
...
-- gef1
-- gub1 1
		t["R005"][3][1] = "레어 등급 유닛의 공격력과 Attack Speed를 증가 시킵니다.";
-- ghk1 1
-- grac
		t["R005"][6][1] = "orc";
-- gar1 1
...
-- gef1
-- gub1 1
		t["R006"][3][1] = "일반 등급 유닛의 공격력과 Attack Speed를 증가 시킵니다.";
-- ghk1 1
-- grac
-- gar1 1
-- gar1 2
...
-- gub1 15
-- gub1 17
		t["R006"][170][1] = "일반, 매직 등급 유닛의 공격력과 Attack Speed를 증가 시킵니다.";
-- gub1 18
-- gub1 16
-- gub1 14
-- gub1 19
...
-- [R007]
-- gnam 1
		t["R007"][1][1] = "Unique and Below Units Upgrade";
-- gef1
-- gub1 1
		t["R007"][3][1] = "*Magic Units Attack +33 , Attack Speed +1%.[Up to 5]\r\
*Rare Units Attack +100, Attack Speed +2%.[Up to 10]\r\
*Unique Units Attack +125, Attack Speed +3%.[Up to 20]";
-- ghk1 1
-- grac
-- gar1 1
-- gar1 2
...
-- gub1 20
-- gub1 22
		t["R007"][175][1] = "유니크 등급 유닛의 공격력과 Attack Speed, 스킬레벨을 증가 시킵니다.";
-- gub1 23
-- gub1 24
-- gub1 25
-- gub1 26
...
-- gtp1 5
		t["R008"][109][1] = "Satori Komeiji Upgrade|cffffcc00(E)|r - |c00ff0000Master|r";
-- gtp1 6
...
-- gtp1 20
		t["R008"][124][1] = "S나에 Upgrade - |c00ff0000Master|r";
-- gtp1 21
-- gtp1 22
-- gtp1 23
-- gtp1 25
...
-- gtp1 50
-- gub1 3
		t["R008"][155][1] = "『브레인 핑거프린트』를 제외한 사토리의 스킬 공격력이 6% 상승합니다. 사토리의 Attack Speed가 15% 상승합니다.\r\
\r\
|c00FF0000*Upgrade 마스터 효과|r :\r\
*|c00FF80FF[활력]|r - 4초\r\
공격한 유닛의 Current Health을 50% 감소시킵니다.[보스 미적용]";
-- gub1 2
-- gub1 4
-- gub1 5
-- gub1 7
		t["R008"][159][1] = "S나에의 공격력을 1500 증가시키고, 매 공격시 주변 300범위에 공격력의 35%만큼 Physical Damage를 줍니다.";
-- gub1 6
		t["R008"][160][1] = "S나에의 공격력을 1500 증가시키고, 매 공격시 주변 300범위에 공격력의 30%만큼의  Physical Damage를 줍니다.";
-- gub1 8
		t["R008"][161][1] = "S나에의 공격력을 1500 증가시키고, 매 공격시 주변 300범위에 공격력의 40%만큼 Physical Damage를 줍니다.";
-- gub1 10
		t["R008"][162][1] = "S나에의 공격력을 1500 증가시키고, 매 공격시 주변 300범위에 공격력의 50%만큼 Physical Damage를 줍니다.";
-- gub1 11
		t["R008"][163][1] = "S나에의 공격력을 1500 증가시키고, 매 공격시 주변 300범위에 공격력의 55%만큼 Physical Damage를 줍니다.";
-- gub1 9
		t["R008"][164][1] = "S나에의 공격력을 1500 증가시키고, 매 공격시 주변 300범위에 공격력의 45%만큼 Physical Damage를 줍니다.";
-- gub1 12
		t["R008"][165][1] = "S나에의 공격력을 1500 증가시키고, 매 공격시 주변 300범위에 공격력의 60%만큼 Physical Damage를 줍니다.";
-- gub1 14
		t["R008"][166][1] = "S나에의 공격력을 1500 증가시키고, 매 공격시 주변 300범위에 공격력의 70%만큼 Physical Damage를 줍니다.";
-- gub1 13
		t["R008"][167][1] = "S나에의 공격력을 1500 증가시키고, 매 공격시 주변 300범위에 공격력의 65%만큼 Physical Damage를 줍니다.";
-- gub1 15
		t["R008"][168][1] = "S나에의 공격력을 1500 증가시키고, 매 공격시 주변 300범위에 공격력의 75%만큼 Physical Damage를 줍니다.";
-- gub1 16
		t["R008"][169][1] = "S나에의 공격력을 1500 증가시키고, 매 공격시 주변 300범위에 공격력의 80%만큼 Physical Damage를 줍니다.";
-- gub1 18
		t["R008"][170][1] = "S나에의 공격력을 1500 증가시키고, 매 공격시 주변 300범위에 공격력의 90%만큼 Physical Damage를 줍니다.";
-- gub1 17
		t["R008"][171][1] = "S나에의 공격력을 1500 증가시키고, 매 공격시 주변 300범위에 공격력의 85%만큼 Physical Damage를 줍니다.";
-- gub1 19
		t["R008"][172][1] = "S나에의 공격력을 1500 증가시키고, 매 공격시 주변 300범위에 공격력의 95%만큼 Physical Damage를 줍니다.";
-- gub1 20
		t["R008"][173][1] = "S나에의 공격력을 1500 증가시키고, 매 공격시 주변 300범위에 공격력의 만큼의  Physical Damage를 줍니다.";
-- gub1 22
-- gub1 23
-- gub1 24
-- gub1 25
...
-- gtp1 5
		t["R00B"][108][1] = "Flandre Scarlet Upgrade|cffffcc00(Q)|r - c00ff0000Master|r";
-- gtp1 6
...
-- gtp1 10
		t["R00B"][113][1] = "Flandre Scarlet Upgrade - |c00ff0000Master|r";
-- gtp1 11
...
-- gtp1 15
		t["R00B"][117][1] = "Shou Toramaru Upgrade - |c00ff0000Master|r";
-- gtp1 14
...
-- gtp1 50
-- gub1 3
		t["R00B"][154][1] = "데미지가 20000 증가하고, Attack Speed가 10% 빨라지며, 금기『레바테인』의 화염폭발 데미지가 7% 증가합니다.\r\
\r\
...
-- gub1 5
-- gub1 7
		t["R00B"][158][1] = "데미지가 2000 증가하고, Attack Speed가 3% 빨라지며, 금기『레바테인』의 체력 비례 데미지가 2% 상승합니다.";
-- gub1 6
-- gub1 8
-- gub1 10
		t["R00B"][161][1] = "데미지가 2000 증가하고, Attack Speed가 3% 빨라지며, 금기『레바테인』의 체력 비례 데미지가 2% 상승하며, 확률이 60%로 변경됩니다.";
-- gub1 11
...
-- gtp1 10
		t["R00C"][113][1] = "Utsuho Reiuji Upgrade|cffffcc00(D)|r - |c00ff0000Master|r";
-- gtp1 11
...
-- gtp1 15
		t["R00C"][117][1] = "피코 우츠호 Upgrade - |c00ff0000Master|r";
-- gtp1 14
...
-- gtp1 50
-- gub1 3
		t["R00C"][154][1] = "Attack Speed가 8% 빨라지고, 핵열『핵반응 제어불능』의 데미지가 25000 증가합니다. 또한 『헬즈 토카막』의 0.5초당 데미지가 7500상승합니다.";
-- gub1 2
-- gub1 4
-- gub1 5
-- gub1 7
...
-- gub1 10
-- gub1 11
		t["R00C"][162][1] = "Attack Speed가 8% 빨라지고, 핵열『핵반응 제어불능』의 데미지가 7000증가하고 확률이 5% 증가합니다.";
-- gub1 9
-- gub1 12
-- gub1 14
-- gub1 13
...
-- gtp1 5
		t["R00D"][108][1] = "와타츠키노 요리히메 Upgrade|cffffcc00(F)|r - |c00ff0000Master|r";
-- gtp1 6
...
-- gtp1 10
		t["R00D"][113][1] = "Ran Yakumo Upgrade|cffffcc00(F)|r - |c00ff0000Master|r";
-- gtp1 11
-- gtp1 12
-- gtp1 13
-- gtp1 15
...
-- gtp1 50
-- gub1 3
		t["R00D"][154][1] = "요리히메의 공격력이 25000, Attack Speed가 12% 상승하며, 모든 스킬이 발동할 확률이 2%씩 상승합니다.\r\
\r\
|c00FF0000*Upgrade 마스터 효과|r : \r\
...
-- gub1 5
-- gub1 7
		t["R00D"][158][1] = "데미지가 1000 증가하고, Attack Speed가 5% 빨라지며, 식휘『호리요괴 레이저』의 데미지가 1,000 증가합니다.";
-- gub1 6
-- gub1 8
-- gub1 10
		t["R00D"][161][1] = "데미지가 1000 증가하고, Attack Speed가 5% 빨라지며, 식휘『호리요괴 레이저』의 데미지가 1,000 증가하며, 지속이 1초 증가합니다.";
-- gub1 11
-- gub1 9
-- gub1 12
-- gub1 14
...
-- gnam 5
-- gnam 6
		t["R00E"][59][1] = "아야 Attack Speed Upgrade";
-- gnam 7
-- gnam 8
-- gnam 9
-- gnam 10
...
-- gtp1 10
		t["R00E"][113][1] = "Nue Houjuu Upgrade|cffffcc00(R)|r - |c00ff0000Master|r";
-- gtp1 11
-- gtp1 12
-- gtp1 13
-- gtp1 15
...
-- gtp1 50
-- gub1 3
		t["R00E"][154][1] = "Attack Speed가 8% 증가하며, 『헤이안 교토의 악몽』의 최고 데미지가 4,000 증가하게 됩니다.";
-- gub1 2
-- gub1 4
-- gub1 5
-- gub1 7
...
-- gub1 8
-- gub1 10
		t["R00E"][161][1] = "Attack Speed가 8% 증가하며, 『헤이안 교토의 악몽』의 데미지가 최소 10,000~최고 50,000의 데미지를 주게 됩니다.";
-- gub1 11
-- gub1 9
-- gub1 12
-- gub1 14
...
-- gtp1 10
		t["R00F"][113][1] = "Koishi Komeiji Upgrade|cffffcc00(E)|r - |c00ff0000Master|r";
-- gtp1 11
...
-- gtp1 15
		t["R00F"][117][1] = "Koishi Komeiji Upgrade - |c00ff0000Master|r";
-- gtp1 14
...
-- gtp1 50
-- gub1 3
		t["R00F"][154][1] = "*공격력이 10000 , Attack Speed가 20% 상승합니다.\r\
*비의『후호의 광언』: 발동 확률이 10%에서 15%로 증가합니다.";
-- gub1 2
		t["R00F"][155][1] = "*공격력이 10000 , Attack Speed가 20% 상승합니다.\r\
*비의『마다라 두카』: Magical Damage 증폭율이 25%에서 45%로 증가합니다.";
-- gub1 4
		t["R00F"][156][1] = "*공격력이 10000 , Attack Speed가 20% 상승합니다.\r\
*비의『칠성의 검』: 전체 체력 비례 데미지가 0.4%에서 0.7%로 상승합니다.";
-- gub1 5
		t["R00F"][157][1] = "Attack Speed가 12% 증가하며, 복연『사랑의 매화』의 크리티컬 비율이 0.75배 증가하게 됩니다.";
-- gub1 7
-- gub1 6
-- gub1 8
-- gub1 10
-- gub1 11
		t["R00F"][162][1] = "Attack Speed가 15% 증가하며, 복연『사랑의 매화』의 크리티컬 비율이 1배 증가하게 됩니다.";
-- gub1 9
-- gub1 12
-- gub1 14
-- gub1 13
...
-- gub1 40
-- gub1 1
		t["R00F"][193][1] = "*공격력이 10000 , Attack Speed가 20% 상승합니다.\r\
...
-- gub1 1
		t["R00O"][4][1] = "판타즘 등급 유닛의 공격력을 20000, Attack Speed를 9% 증가시킵니다.";
-- ghk1 1
		t["R00O"][5][1] = "A";
-- grac
-- gar1 1
...
-- gub1 6
		t["R00O"][40][1] = "판타즘 등급 유닛의 공격력을 10000, Attack Speed를 9% 증가시킵니다.";
-- gub1 7
-- gub1 8
-- gub1 10
-- gub1 9
...
-- gtp1 10
		t["R00P"][113][1] = "Kaguya Houraisan Upgrade|cffffcc00(E)|r - c00ff0000Master|r";
-- gtp1 11
-- gtp1 12
-- gtp1 13
-- gtp1 15
...
-- gtp1 50
-- gub1 3
		t["R00P"][154][1] = "데미지가 12000 증가하며 Attack Speed가 6% 증가합니다. 신난제『에이쟈의 붉은 돌』의 Attack Speed 증가가 50% 증가하며, 대상 개체가 1체 증가합니다.";
-- gub1 2
-- gub1 4
-- gub1 5
-- gub1 7
...
-- gtp1 5
		t["R00Q"][108][1] = "Yumeko Upgrade|cffffcc00(Q)|r - c00ff0000Master|r";
-- gtp1 6
...
-- gtp1 10
		t["R00Q"][113][1] = "Fujiwara no Mokou Upgrade|cffffcc00(F)|r - |c00ff0000Master|r";
-- gtp1 11
...
-- gtp1 15
		t["R00Q"][117][1] = "Fujiwara no Mokou Upgrade - |c00ff0000Master|r";
-- gtp1 14
...
-- gub1 5
-- gub1 7
		t["R00Q"][158][1] = "데미지가 2500, Attack Speed가 12% 증가하며 『피닉스 재탄생』의 주변 데미지가 3500증가합니다.";
-- gub1 6
-- gub1 8
-- gub1 10
-- gub1 11
		t["R00Q"][162][1] = "데미지가 3000, Attack Speed가 5% 증가하며 『포제스트 바이 피닉스』의 폭팔 데미지가 15000 증가하게됩니다.";
-- gub1 9
-- gub1 12
-- gub1 14
-- gub1 13
-- gub1 15
		t["R00Q"][167][1] = "데미지가 3000, Attack Speed가 5% 증가하며 『포제스트 바이 피닉스』의 이동속도가 400으로 줄어들고, 폭팔 데미지가 15000 증가하게됩니다";
-- gub1 16
-- gub1 18
-- gub1 17
-- gub1 19
...
-- gtp1 5
		t["R00R"][108][1] = "Byakuren Hijiri Upgrade|cffffcc00(R)|r - |c00ff0000Master|r";
-- gtp1 6
-- gtp1 7
-- gtp1 8
-- gtp1 9
...
-- gtp1 50
-- gub1 3
		t["R00R"][154][1] = "*공격력이 3,000 증가합니다.\r\
\r\
...
-- gtp1 5
		t["R00T"][108][1] = "Yukari Yakumo Upgrade|cffffcc00(W)|r - |c00ff0000Master|r";
-- gtp1 6
-- gtp1 7
-- gtp1 8
-- gtp1 9
...
-- gtp1 50
-- gub1 3
		t["R00T"][154][1] = "Attack Speed가 12% 빨라지며 유카리의 스킬이 강화됩니다.\r\
\r\
...
-- gtp1 5
		t["R00U"][109][1] = "Yuuka Kazami Upgrade|cffffcc00(Q)|r - |c00ff0000Master|r";
-- gtp1 6
-- gtp1 7
-- gtp1 8
-- gtp1 9
...
-- gtp1 50
-- gub1 3
		t["R00U"][155][1] = "공격력을 25000 , Attack Speed를 18%만큼 증가시킵니다. 유카의『플라워 듀얼 스파크』의 체력 비례 데미지가 0.3%p 상승합니다.\r\
\r\
...
-- gtp1 5
		t["R00V"][109][1] = "Eirin Yagokoro Upgrade|cffffcc00(W)|r - |c00ff0000Master|r";
-- gtp1 6
-- gtp1 7
-- gtp1 8
-- gtp1 9
...
-- gtp1 5
		t["R00W"][109][1] = "Suwako Moriya Upgrade|cffffcc00(S)|r - |c00ff0000Master|r";
-- gtp1 6
-- gtp1 7
-- gtp1 8
-- gtp1 9
...
-- gtp1 50
-- gub1 3
		t["R00W"][155][1] = "*Suwako Moriya의 공격력을 35000 증가시키고 Attack Speed를 15% 상승시킵니다. 추가로 『테나가아시나가님』의 발동 확률이 1% 증가합니다.\r\
\r\
|c00FF0000*Upgrade 마스터 효과|r : *스와코가 자신의 영역에 발을 들이는 적에게 저주를 내립니다. 라인존에 나타나는 적이 받는 Magical Damage를 12% 증폭시키고, 체력을 7% 감소시킵니다.";
-- gub1 2
-- gub1 4
-- gub1 5
-- gub1 7
...
-- gtp1 5
		t["R00X"][108][1] = "Kana Anaberal Upgrade|cffffcc00(S)|r - |c00ff0000Master|r";
-- gtp1 6
...
-- gtp1 10
		t["R00X"][113][1] = "Kanako Yasaka Upgrade|cffffcc00(A)|r - |c00ff0000Master|r";
-- gtp1 11
-- gtp1 12
-- gtp1 13
-- gtp1 15
...
-- gub1 5
-- gub1 7
		t["R00X"][158][1] = "Attack Speed가 6% 증가하고, 데미지가 6000증가하며, 천류『천수의 기적』의 방어력 감소치가 25, 이동속도 감소치가 3%증가하며, 기제『메도테코 난무』의 떨어지는 횟수가 1회 증가합니다.";
-- gub1 6
-- gub1 8
-- gub1 10
-- gub1 11
...
-- gtp1 10
		t["R00Y"][113][1] = "Ghost Orchestra[Phantom Ensemble] Upgrade|cffffcc00(W)|r - |c00ff0000Master|r";
-- gtp1 11
-- gtp1 12
-- gtp1 13
-- gtp1 15
...
-- gtp1 50
-- gub1 3
		t["R00Y"][154][1] = "Shinki의 공격력이 15000, Attack Speed가 12% 상승합니다.\r\
\r\
...
-- gub1 5
-- gub1 7
		t["R00Y"][158][1] = "Attack Speed가 8%, 데미지가 10000증가하며 명관『고스트 클리포드』의 데미지가 0.25초당 10000씩 증가합니다.";
-- gub1 6
-- gub1 8
-- gub1 10
-- gub1 11
...
-- gtp1 10
		t["R010"][113][1] = "Medicine Melancholy Upgrade|cffffcc00(S)|r - |c00ff0000Master|r";
-- gtp1 11
-- gtp1 12
-- gtp1 13
-- gtp1 15
...
-- gtp1 50
-- gub1 3
		t["R010"][154][1] = "Attack Speed +10% and Attack +3000. Increase Poison Sign 『Poison Breath』's tick damage by 10000.";
-- gub1 2
-- gub1 4
-- gub1 5
-- gub1 7
...
-- gtp1 10
		t["R012"][111][1] = "레밀리아 스칼렛 Upgrade|cffffcc00(A)|r - |c00ff0000Master|r";
-- gtp1 11
-- gtp1 12
-- gtp1 13
-- gtp1 15
...
-- gtp1 50
-- gub1 3
		t["R012"][152][1] = "Attack Speed가 7% 상승하고 데미지가 6천 증가합니다. 『데몬 로드 크레이들』초당 데미지가 2500,000큼 증가합니다.";
-- gub1 2
-- gub1 4
-- gub1 5
-- gub1 7
...
-- gtp1 10
		t["R00J"][113][1] = "모노노베노 후토 Upgrade|cffffcc00(D)|r - |c00ff0000Master|r";
-- gtp1 11
-- gtp1 12
-- gtp1 13
-- gtp1 15
...
-- gtp1 50
-- gub1 3
		t["R00J"][154][1] = "Attack Speed가 7% 상승하고, 데미지가 4500증가하며 염부『폐불의 염풍』의 데미지가 5000, 지속 데미지가 2500이 증가합니다.";
-- gub1 2
-- gub1 4
-- gub1 5
-- gub1 7
...
-- gtp1 5
		t["R00L"][108][1] = "Junko Upgrade|cffffcc00(E)|r - c00ff0000Master|r";
-- gtp1 6
...
-- gtp1 10
		t["R00L"][113][1] = "Yuyuko Saigyouji Upgrade|cffffcc00(D)|r - |c00ff0000Master|r";
-- gtp1 11
-- gtp1 12
-- gtp1 13
-- gtp1 15
...
-- gtp1 50
-- gub1 3
		t["R00L"][154][1] = "Junko의 공격력이 25000, Attack Speed가 16% 상승합니다.『떨며 얼어붙는 별』의 발동 확률이 0.5% 상승합니다.\r\
\r\
...
-- gub1 5
-- gub1 7
		t["R00L"][158][1] = "Attack Speed가 4% 상승하고, 데미지가 6500증가하며 재미『환상향의 황천돌아가기』의 데미지가 5000, 250범위 데미지가 7000, 100범위 데미지가 10000,000큼 증가합니다.";
-- gub1 6
-- gub1 8
-- gub1 10
-- gub1 11
...
-- gtp1 5
		t["R01D"][108][1] = "Raiko Horikawa Upgrade|cffffcc00(A)|r - |c00ff0000Master|r";
-- gtp1 6
...
-- gtp1 10
		t["R01D"][113][1] = "Toyosatomimi no Miko Upgrade|cffffcc00(S)|r - |c00ff0000Master|r";
-- gtp1 11
-- gtp1 12
-- gtp1 13
-- gtp1 15
...
-- gtp1 50
-- gub1 3
		t["R01D"][154][1] = "라이코의 Attack Speed가 16% 상승합니다.\r\
\r\
...
-- gub1 5
-- gub1 7
		t["R01D"][158][1] = "Attack Speed가 10% 상승하고, 데미지가 4500증가하며 『별이 내리는 신령묘』의 틱이 0.1초 감소합니다.";
-- gub1 6
		t["R01D"][159][1] = "Attack Speed가 10% 상승하고, 데미지가 4500증가하며 『별이 내리는 신령묘』의 데미지가 4000 증가합니다.";
-- gub1 8
-- gub1 10
-- gub1 11
-- gub1 9
...
-- gtp1 10
		t["R01E"][113][1] = "Letty Whiterock Upgrade|cffffcc00(A)|r - |c00ff0000Master|r";
-- gtp1 11
-- gtp1 12
-- gtp1 13
-- gtp1 15
...
-- gtp1 50
-- gub1 3
		t["R01E"][154][1] = "Attack Speed가 8% 상승하고, 데미지가 4000증가하며 동부『노던 위너』의 0.25초당 데미지가 3000 상승합니다.";
-- gub1 2
-- gub1 4
-- gub1 5
-- gub1 7
...
-- gtp1 5
		t["R01G"][109][1] = "Toyosatomimi no Miko Upgrade|cffffcc00(Q)|r - |c00ff0000Master|r";
-- gtp1 6
-- gtp1 7
-- gtp1 8
-- gtp1 9
...
-- gtp1 50
-- gub1 3
		t["R01G"][155][1] = "미코의 공격력을 25000 , Attack Speed를 12% 만큼 증가시킵니다. \r\
...
-- gtp1 5
		t["R01H"][105][1] = "Kasen Ibaraki Upgrade|cffffcc00(W)|r - |c00ff0000Master|r";
-- gtp1 6
-- gtp1 7
-- gtp1 8
-- gtp1 9
...
-- gtp1 5
		t["R01I"][108][1] = "Tenshi Hinanawi Upgrade|cffffcc00(A)|r - |c00ff0000Master|r";
-- gtp1 6
...
-- gtp1 10
		t["R01I"][113][1] = "Aya Shameimaru Upgrade|cffffcc00(E)|r - |c00ff0000Master|r";
-- gtp1 11
-- gtp1 12
-- gtp1 13
-- gtp1 15
...
-- gef1
-- gub1 1
		t["R01K"][3][1] = "매직 등급 유닛의 공격력과 Attack Speed를 증가 시킵니다.";
-- ghk1 1
-- grac
-- gar1 1
-- gar1 2
...
-- gtp1 5
		t["R01M"][21][1] = "Seija Kijin Upgrade|cffffcc00(S)|r - |c00ff0000Master|r";
-- gub1 2
-- gub1 3
-- gub1 4
-- gub1 5
...
-- gtp1 50
-- gub1 3
		t["R01Q"][154][1] = "*에픽 유닛의 Attack Speed를 6% 만큼 증가시킵니다.";
-- gub1 2
-- gub1 4
-- gub1 5
-- gub1 7
...
-- gtp1 5
		t["R01S"][108][1] = "Suika Ibuki Upgrade|cffffcc00(W)|r - |c00ff0000Master|r";
-- gtp1 6
...
-- gtp1 10
		t["R01S"][113][1] = "Beer Child Upgrade|cffffcc00(S)|r - |c00ff0000Master|r";
-- gtp1 11
-- gtp1 12
-- gtp1 13
-- gtp1 15
...
-- gtp1 50
-- gub1 3
		t["R01S"][154][1] = "*스이카의 공격력이 75000, Attack Speed가 8% 증가합니다.\r\
\r\
...
-- gtp1 5
		t["R01F"][108][1] = "Sumireko Usami Upgrade|cffffcc00(R)|r - |c00ff0000Master|r";
-- gtp1 6
-- gtp1 7
-- gtp1 8
-- gtp1 9
...
-- gtp1 50
-- gub1 3
		t["R01F"][154][1] = "*공격력이 25000 , Attack Speed가 14% 증가하고, 『3D 프린터건』의 발동 확률이 2% 증가합니다.\r\
\r\
...
-- gef1
-- gub1 1
		t["R00A"][3][1] = "레전더리 유닛들의 공격력을 10000, Attack Speed를 12% 상승시킵니다.";
-- ghk1 1
-- grac
-- gar1 1
...
-- gub1 5
-- gub1 7
		t["R00A"][160][1] = "레전더리 유닛들의 공격력을 7500, Attack Speed를 6% 상승시킵니다.";
-- gub1 6
-- gub1 8
-- gub1 10
-- gub1 11
		t["R00A"][164][1] = "유니크 등급 이하 유닛의 공격력과 Attack Speed, 스킬레벨을 증가 시킵니다.";
-- gub1 9
-- gub1 12
-- gub1 14
-- gub1 13
...
-- gtp1 5
		t["R01X"][108][1] = "Yumemi Okazaki Upgrade|cffffcc00(R)|r - |c00ff0000Master|r";
-- gtp1 6
-- gtp1 7
-- gtp1 8
-- gtp1 9
...
-- gtp1 50
-- gub1 3
		t["R01X"][154][1] = "*데미지가 30000 증가하고, Attack Speed가 12% 상승합니다.\r\
...
-- gtp1 50
-- gub1 3
		t["R01Y"][154][1] = "*Attack Speed가 12% 상승합니다. 공격시 회복하는 마나가 0.4 증가합니다.\r\
\r\
...
-- gtp1 5
		t["R01Z"][108][1] = "Hata no Kokoro Upgrade|cffffcc00(D)|r - |c00ff0000Master|r";
-- gtp1 6
-- gtp1 7
-- gtp1 8
-- gtp1 9
...
-- gef1
-- gub1 1
		t["R021"][3][1] = "*에픽 유닛들의 공격력을 4000, Attack Speed를 4% 상승시킵니다.\r\
*Extended 유닛의 공격력을 6000 , Attack Speed를 10% 상승시킵니다.\r\
*Magical Damage 에픽 유닛은 공격력이 상승하지 않는 대신 Attack Speed를 6% 상승시킵니다.";
-- ghk1 1
-- grac
-- gar1 1
...
-- gub1 10
-- gub1 11
		t["R021"][164][1] = "에픽 유닛들의 공격력을 3500, Attack Speed를 8% 상승시킵니다.";
-- gub1 9
-- gub1 12
-- gub1 14
-- gub1 13
...
-- gtp1 5
		t["R00H"][108][1] = "Gengetsu Upgrade|cffffcc00(S)|r - c00ff0000Master|r";
-- gtp1 6
-- gtp1 7
-- gtp1 8
-- gtp1 9
...
-- gtp1 50
-- gub1 3
		t["R00H"][154][1] = "Gengetsu의 공격력이 15000 증가하며, Attack Speed가 10% 증가합니다. Gengetsu의 스킬이 발동할 확률이 0.5% 상승합니다.\r\
\r\
|c00FF0000*Upgrade 마스터 효과|r : 『천사와 악마』의 Magical Damage 증폭률이 20%에서 30%로 증가합니다.";
-- gub1 2
-- gub1 4
-- gub1 5
-- gub1 7
...
-- gtp1 5
		t["R00M"][108][1] = "Elly Upgrade|cffffcc00(E)|r - |c00ff0000Master|r";
-- gtp1 6
-- gtp1 7
-- gtp1 8
-- gtp1 9
...
-- gtp1 50
-- gub1 3
		t["R00M"][154][1] = "엘리의 공격력이 50000 증가하며, Attack Speed가 12% 증가합니다.\r\
\r\
...
-- gtp1 5
		t["R00S"][108][1] = "콘가라 Upgrade|cffffcc00(D)|r - |c00ff0000Master|r";
-- gtp1 6
-- gtp1 7
-- gtp1 8
-- gtp1 9
...
-- gtp1 50
-- gub1 3
		t["R00S"][154][1] = "*공격력이 35000 상승하고, Attack Speed가 12% 상승합니다.\r\
\r\
|c00FF0000*Upgrade 마스터 효과|r :\r\
...
-- gtp1 50
-- gub1 3
		t["R013"][154][1] = "*Mima의 Attack Speed가 10% , 스킬 공격력이 4% 증가합니다.\r\
...
-- gtp1 5
		t["R014"][108][1] = "Kurumi Upgrade|cffffcc00(A)|r - |c00ff0000Master|r";
-- gtp1 6
-- gtp1 7
-- gtp1 8
-- gtp1 9
...
-- gtp1 50
-- gub1 3
		t["R015"][154][1] = "＊Elis의 Attack Speed가 13% 증가합니다.\r\
\r\
