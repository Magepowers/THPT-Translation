...
-- atar 3
-- atp1 3
		t["AOw2"][11][1] = "[Epic] 아야 : 450 1.8초 75만";
-- atar 4
-- atp1 4
		t["AOw2"][14][1] = "[Unique] 세이가 : 800 0.8초 4만5천";
-- atar 5
-- atp1 5
...
-- aub1 1
		t["Afrz"][9][1] = "＊|c00FF80FF[활력]|r - 5초 : Hisoutensoku이 핵열로 강화된 증기 기관을 통해 열기를 뿜어 자신 주변 600 범위의 적에게 잃은 체력 1% + 125만의 |c00AC59FF절대 피해|r를 가합니다.\r\
|c00FF712D[허영갑주]|r + 4";
-- [Absk]
-- anam
-- arac
...
-- aub1 1
		t["A0JX"][7][1] = "＊컬러 UFO를 해체합니다. 해체는 5초 동안 진행되며 취소할 수 있습니다.\r\
...
-- aub1 1
		t["A0M1"][5][1] = "|c00A8F13A[Combination]|r: Futatsuiwa Mamizou[Epic] + Koishi Komeiji[Epic] + 호우쥬 누에[Epic] + 2 Unique Souls \r\
\r\
[Attack Speed]: 0.42 Cooldown\r\
[Movement Speed]: 300\r\
...
-- arac
-- aub1 1
		t["A0M2"][7][1] = "Futatsuiwa Mamizou[Epic] + Koishi Komeiji[Epic] + 호우쥬 누에[Epic] + 2 Unique Souls ";
-- ahky
-- atat
		t["A0M2"][11][1] = "h06K";
-- alig
...
-Sho Toramaru우[Epic],호우쥬 누에[Epic] -> |c00FF6464물리 데미지|r의 Murasa로 변경";
-- aart
...
\r\
|c00ffff00!주의 : 대상이 된 오노즈카 코마치[Unique]는 사라집니다.|r";
-- aart
-- atar 1
-- ahky
-- [A0AB]
...
-- arac
-- anam
		t["A0IM"][3][1] = "[Legendary][호우쥬 누에]탄막 키메라";
-- atp1 1
...
*로열 플Rare에 휘말린 적은 마법에 대항할 능력을 잃어버려 5초간 마법 데미지를 40% 증폭하여 받습니다.";
-- aub1 2
...
-- anam
-- atp1 1
		t["A0NF"][3][1] = "|c00FEE952[Unit Information]|r - 오노즈카 코마치[Legendary]";
-- aub1 1
...
-- aub1 1
		t["A09X"][7][1] = "*순호가 왠지 모르게 달토끼 한마리를 귀여워하고 싶어합니다. 레이센 우돈게인 이나바[Unique]에게 사용할 경우, 『지상의 더러움의 순화』를 얻습니다.\r\
\r\
|c00ffff00!주의 : 대상이 된 레이센 우돈게인 이나바[Unique]은 사라집니다.|r";
-- aart
-- atar 1
-- ahky
-- [A07R]
