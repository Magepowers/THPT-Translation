...
*Sunny Milk가 공격시 10% 확률로 전방으로 눈이 멀정도로 강력한 햇빛을 발사합니다. 전방 650범위 Units에게 85만의 절대 데미지를 입히고, 1.5 seconds간 스턴시킵니다.\r\
...
＊공격 시 10% 확률로 하늘과 땅을 뒤집어 엎어 대상 주변 450 범위의 적에게 55만의 |c00FF6464물리 피해|r를 가하고 2.5 seconds간 기절시킵니다.";
-- abuf 1
		t["ACav"][8][1] = "BUav";
-- atp1 2
...
*세이자가 공격시 12% 확률로 대상 지점 주변 450범위를 뒤집어놓아 범위 내의 적을 1.8 seconds간 기절시키고, 80만의 |c00FF6464물리 데미지|r를 입힙니다.";
-- atar 2
-- abuf 2
-- atar 3
-- atp1 3
...
*대상 지점 주변 500범위 내에 있는 적을 1.5 seconds간 스턴시키고, 전체 체력의 0.8% + 110만의 |c00FF6464물리 데미지|r를 입힙니다.";
-- [AHtb]
-- amat
...
-- atar 3
-- atp1 3
		t["AOw2"][11][1] = "[Epic] 아야 : 450 1.8 seconds 75만";
-- atar 4
-- atp1 4
		t["AOw2"][14][1] = "[Unique] 세이가 : 800 0.8 seconds 4만5천";
-- atar 5
-- atp1 5
...
-- atp1 9
		t["AOw2"][24][1] = "[Epic] 레티 : 400 1.6초 80만";
-- atar 9
-- atar 10
-- atp1 10
...
*Tokiko가 공격시 10% 확률로 대상 주변 475범위의 적에게 책을 읽으라고 일갈하여 1.7초의 스턴과 55만의 |c00AC59FF절대 데미지|r를 입힙니다.\r\
|c00FF712D[허영갑주]|r + 4";
-- [ANth]
-- aart
...
-- aub1 1
		t["Afrz"][9][1] = "＊|c00FF80FF[활력]|r - 5 seconds : Hisoutensoku이 핵열로 강화된 증기 기관을 통해 열기를 뿜어 자신 주변 600 범위의 적에게 잃은 체력 1% + 125만의 |c00AC59FF절대 피해|r를 가합니다.\r\
|c00FF712D[허영갑주]|r + 4";
-- [Absk]
-- anam
-- arac
...
*보스 공격시 30% 확률로 1.5 seconds간 스턴시키고 전체 체력의 0.3% + 90만의 추가 |c00379BFF마법 데미지|r를 입힙니다.";
-- atar 1
		t["Aeat"][9][1] = "none";
-- [ACce]
-- atar 1
...
-- aub1 1
		t["ANb2"][3][1] = "*레밀리아가 공격할 시 15% 확률로 대상 적을 1.8 seconds간 스턴시키며 145만의 \r\
...
-- ahky
-- aub1 1
		t["ACcr"][4][1] = "*대상 Unique 소울을 섭취합니다. 맛있을지는 모르겠지만...";
-- anam
		t["ACcr"][5][1] = "[섭취]";
-- [Aply]
-- [AOsf]
...
-- anam
		t["ACfn"][4][1] = "[향림당]";
-- aub1 1
		t["ACfn"][5][1] = "*자경단 보스에게 사용할 수 있습니다. 사용시 전체 체력의 4%에 해당하는 절대 데미지를 입히고, 5 seconds간 기절시킵니다.\r\
*Cooldown 120초";
-- aart
-- [AId0]
-- anam
...
*시리코다마를 6개 만들때마다 뽑아낸 시리코다마를 이용해 시리듐 원자로를 만들어 폭발시킵니다. 자신 주변 1000범위 내에 있는 적에게 1.5 seconds의 스턴과 전체 체력의 1% + 400만의 마법 데미지를 입힙니다.";
-- [ANst]
-- aefs
-- aefl
-- anam
...
-- anam
-- aub1 1
		t["ACcl"][7][1] = "*Unique 소울에 흡수하여 반역할 힘을 얻습니다.『천양몽궁의 조칙』스킬을 얻습니다.\r\
*대상이 된 Unique 소울은 제거됩니다.";
-- atar 1
-- ahky
-- [ANs3]
-- anam
...
-- atp1 1
		t["A02Q"][2][1] = "허사『환상향전설』";
-- aub1 1
		t["A02Q"][3][1] = "*공격시 15% 확률로 대상 Units을 1.5 seconds간 스턴시키고 전체 체력의 9%의 |c00379BFF마법 데미지|r를 입힙니다. \r\
...
-- aub1 1
		t["A02T"][3][1] = "|c00A8F13A[Combination]|r: Houraisan Kaguya[Epic] + Kanako Yasaka[Epic] + 달의 조각 + 고대와 환상의 조각\r\
...
-- atp1 30
-- aub1 2
		t["A04I"][38][1] = "코마치의 Normal 공격은 대상의 방어력을 25만큼 감소시킨 후 데미지가 들어갑니다.";
-- aub1 3
		t["A04I"][39][1] = "코마치의 Normal 공격은 대상의 방어력을 35만큼 감소시킨 후 데미지가 들어갑니다.";
-- aub1 4
...
-- aub1 1
		t["A04R"][3][1] = "＊공격 시 18% 확률로 심판을 내려 대상 주변 400 범위의 적에게 105만의 |c00379BFF마법 피해|r를 가하고 1.5 seconds간 기절시킵니다.\r\
...
-- atp1 31
-- aub1 2
		t["A04R"][36][1] = "＊공격 시 18% 확률로 심판을 내려 대상 주변 400 범위의 적에게 155만의 |c00379BFF마법 피해|r를 가하고 1.8 seconds간 기절시킵니다.\r\
＊공격한 적이 보스가 아니고 체력이 50% 이하라면, 전체 체력 1%의 |c00379BFF마법 피해|r를 가합니다.";
-- aub1 3
...
-- aub1 12
		t["A04U"][44][1] = "매 공격시 80%의 확률로 주변 1200범위에 51000+(웨이브 몹의 현재체력*0.11)의 데미지를 줍니다. Cooldown 1.8 seconds.";
-- aub1 13
		t["A04U"][45][1] = "매 공격시 85%의 확률로 주변 1200범위에 54000+(웨이브 몹의 현재체력*0.12)의 데미지를 줍니다. Cooldown 1.8 seconds.";
-- aub1 14
		t["A04U"][46][1] = "매 공격시 90%의 확률로 주변 1200범위에 57000+(웨이브 몹의 현재체력*0.13)의 데미지를 줍니다. Cooldown 1.8 seconds.";
-- aub1 15
		t["A04U"][47][1] = "매 공격시 95%의 확률로 주변 1200범위에 60000+(웨이브 몹의 현재체력*0.14)의 데미지를 줍니다. Cooldown 1.8 seconds.";
-- aub1 16
		t["A04U"][48][1] = "매 공격시 주변 1200범위에 63000+(웨이브 몹의 현재체력*0.15)의 데미지를 줍니다. Cooldown 1.8 seconds.";
-- aub1 17
-- aub1 18
-- aub1 19
-- aub1 20
...
-- aub1 3
		t["A04W"][37][1] = "매 공격시 25%의 확률로 2초동안 0.25 seconds당 7만 데미지의 탄막을 무작위 범위에 발사합니다.";
-- aub1 4
		t["A04W"][38][1] = "매 공격시 25%의 확률로 2초동안 0.25 seconds당 8만 데미지의 탄막을 무작위 범위에 발사합니다.";
-- aub1 5
		t["A04W"][39][1] = "매 공격시 25%의 확률로 2초동안 0.25 seconds당 9만 데미지의 탄막을 무작위 범위에 발사합니다.";
-- aub1 6
		t["A04W"][40][1] = "매 공격시 25%의 확률로 2초동안 0.25 seconds당 10만 데미지의 탄막을 무작위 범위에 발사합니다.";
-- aub1 7
		t["A04W"][41][1] = "매 공격시 25%의 확률로 2초동안 0.25 seconds당 11만 데미지의 탄막을 무작위 범위에 발사합니다.";
-- aub1 8
		t["A04W"][42][1] = "매 공격시 25%의 확률로 2초동안 0.25 seconds당 12만 데미지의 탄막을 무작위 범위에 발사합니다.";
-- aub1 9
		t["A04W"][43][1] = "매 공격시 25%의 확률로 2초동안 0.25 seconds당 13만 데미지의 탄막을 무작위 범위에 발사합니다.";
-- aub1 11
		t["A04W"][44][1] = "매 공격시 25%의 확률로 3초동안 0.25 seconds당 15만 데미지의 탄막을 무작위 범위에 발사합니다.";
-- aub1 10
		t["A04W"][45][1] = "매 공격시 25%의 확률로 2초동안 0.25 seconds당 14만 데미지의 탄막을 무작위 범위에 발사합니다.";
-- aub1 12
		t["A04W"][46][1] = "매 공격시 80%의 확률로 주변 1200범위에 117000의 데미지를 줍니다. Cooldown 3초.";
-- aub1 13
		t["A04W"][47][1] = "매 공격시 85%의 확률로 주변 1200범위에 1240000의 데미지를 줍니다. Cooldown 3초.";
-- aub1 14
...
-Koishi Komeiji[Ascended]를 보유하고 있을 경우, 잃은 체력 0.3% + 75만의 |c00379BFF마법 피해|r로 변경됩니다.";
-- atp1 1
...
-- aub1 1
		t["A072"][3][1] = "＊공격 시 10% 확률로 자신 주변 400 범위의 적에게 3만의 |c00FF6464물리 피해|r를 가하고 5 seconds간 아군 공격력을 15% 증가시킨다.";
-- anam
-- aart
...
폭발에 휘말린 600범위 내의 적은 Movement Speed가 5 seconds간 40% 감소하며 60만의 물리데미지를 입습니다.";
-- abuf 6
-- abuf 7
-- atp1 7
		t["A085"][49][1] = "[천지유용]";
...
-- aub1 1
		t["A086"][4][1] = "＊공격 시 20% 확률로 폭풍을 일으켜 자신 주변 550 범위의 적에게 3만의 |c00FF6464물리 피해|r를 가하고 1.5 seconds간 Movement Speed를 25% 감소시킨다.";
-- aart
...
*Kappa단원이 공격시 마나를 1 회복하며, 마나가 75가 될때마다 진귀한 오이인 '비트오이'를 먹고 폭발합니다. 자신 주변 650범위 내에 있는 적에게 220만의 |c00379BFF마법 데미지|r와 1.8 seconds의 스턴을 입힙니다.[폭발한다고 사라지지는 않습니다.]\r\
...
-- atp1 6
-- aub1 2
		t["A091"][10][1] = "공격 시 13%의 확률로 공격 대상 주위의 700 범위에 55만의 물리 데미지와 0.75 seconds 스턴을 줍니다.";
-- aub1 3
		t["A091"][11][1] = "공격 시 13%의 확률로 공격 대상 주위의 700 범위에 60만의 데미지와 1초 스턴을 줍니다.";
-- aub1 4
		t["A091"][12][1] = "공격 시 13%의 확률로 공격 대상 주위의 700 범위에 65만의 데미지와 1.25 seconds 스턴을 줍니다.";
-- aub1 5
		t["A091"][13][1] = "공격 시 13%의 확률로 공격 대상 주위의 700 범위에 70만의 데미지와 1.5 seconds 스턴을 줍니다.";
-- aub1 6
		t["A091"][14][1] = "공격 시 13%의 확률로 공격 대상 주위의 700 범위에 75만의 데미지와 1.5 seconds 스턴을 줍니다.";
-- arac
-- [A094]
-- arac
-- atp1 1
...
*공격시 15% 확률로Instantly kills a target unit. 공격한 대상 Units의 체력이 70% 이상이라면 대상 전체 체력의 15%의 |c00FF6464물리 데미지|r를 입힙니다.\r\
...
-- atp1 31
-- aub1 2
		t["A0A3"][36][1] = "*케이네가 공격시 9% 확률로 대상 지점 주변 400범위 내의 적의 역사를 뒤틀어 60만의 |c00AC59FF절대 데미지|r를 입히고, 2.5 seconds간 스턴시킵니다.\r\
...
-- aub1 1
		t["A0AA"][3][1] = "＊공격 시 10% 확률로 대상에게 전체 체력의 3% + 175만(보스 175만)의 |c00379BFF마법 피해|r를 가하고 2.5 seconds간 기절시키며, 대상 주변 450 범위의 적에게 105만의 |c00379BFF마법 피해|r를 가합니다.";
-- anam
-- aart
...
*공격시 16% 확률로 자신 주변 600범위 적에게 80만의 |c00FF6464물리 데미지|r를 입히고, 2.5 seconds간 기절시킵니다.\r\
|c00FF712D[허영갑주]|r + 3";
-- atp1 2
...
-- aub1 1
		t["A09Y"][4][1] = "*대상 적 Units의 Movement Speed를 5 seconds간 50%만큼 감소시키고, 방어력을 45만큼 10초간 감소시킵니다.\r\
...
-- arac
-- aub1 1
		t["A0BJ"][7][1] = "사이교우지 유유코 + Komachi Onozuka + 레티 화이트락";
-- ahky
-- alig
-- atat
		t["A0BJ"][12][1] = "h03Z";
...
*카구야가 공격시 마나를 1씩 회복합니다. 마나가 110이 됐을때 대상 지점 주변 750범위 내에 있는 적에게 400만의 |c00AC59FF절대 데미지|r와 잃은 체력의 8%의 |c00FF6464물리 데미지|r를 입히고 2.5 seconds간 스턴시킵니다.\r\
ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ\r\
신난제『달의 일메나이트』\r\
\r\
...
텐시가 전방의 Units에게 전체 체력의 0.5% + 50만의 마법 데미지를 입히고, 2.5 seconds간 스턴시킵니다.\r\
...
-- atp1 1
		t["A017"][2][1] = "『마공학 중력장』";
-- aub1 1
		t["A017"][3][1] = "*리카코가 공격시 9% 확률로 대상 지점에 중력장을 생성합니다. 중력장 주변 400범위 적에게 110만의 |c00FF6464물리 데미지|r를 입히고, 2.5 seconds간 스턴시킵니다.\r\
*이 스킬이 발동할때마다『오버플로우』의 활력 Cooldown이 0.2초씩 감소합니다.";
-- [A0C3]
-- anam
...
-- aub1 1
		t["A0C9"][3][1] = "조건 : 패시브\r\
유효 범위 : 대상\r\
|c00379BFF마법 피해|r : 5 seconds 동안 1초마다 1만2천\r\
...
*사쿠야가 공격시 10% 확률로 적에게 보이지 않을 정도로 빠르게 나이프를 휘둘러 대상 주변 500범위 적에게 현재 체력의 1% + 120만의 |c00FF6464물리 데미지|r를 입히고, 1.5 seconds간 스턴시킵니다.";
-- atar 1
		t["A0CC"][4][1] = "notself";
-- aart
...
-- aub1 1
		t["A0CO"][3][1] = "*레이무가 공격시 10% 확률로 대상 지점에 부적을 투척하여 요력을 막는 결계를 생성합니다. 대상 지점 주변 400범위 내의 적을 2.5 seconds간 스턴시키고, 전체 체력의 0.4% + 100만의 |c00FF6464물리 데미지|r를 입힙니다.\r\
ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ\r\
몽부『환상일중』\r\
\r\
*레이무가 공격시 10% 확률로 대상 지점 주변 400범위 적을 2.5 seconds간 스턴시키고, 현재 체력의 0.7% + 125만의 |c00FF6464물리 데미지|r를 입힙니다.\r\
...
*대상 지점 주변 400범위 내에 있는 적을 1.5 seconds간 스턴시키고, 전체 체력의 0.6% + 150만의 |c00FF6464물리 데미지|r를 입힙니다.";
-- [A0CP]
-- anam
-- atp1 1
...
『저체온증』\r\
\r\
＊공격한 대상이 보스라면, 50% 확률로 현재 체력 0.4% + 15만의 |c00379BFF마법 피해|r를 가하고 1.5 seconds간 기절시킵니다.";
-- aart
...
-- anam
-- atp1 1
		t["A0FN"][3][1] = "|c00FEE952[Unit Information]|r - 사이교우지 유유코[반혼접][Epic]";
-- aub1 1
...
『선우후락의 검』\r\
\r\
*『비상비비상비의 검』을 5회 발동할때마다 주변 800범위 적을 5 seconds간 스턴시키고 450만의 |c00379BFF마법 데미지|r를 입힙니다.\r\
...
*유메미의 마나가 120이 됐을때 공격한 지점에 딸기색의 십자가를 생성합니다. 십자가는 주변 600범위 Units을 4.5 seconds간 스턴시키며 적 현재 체력 3% + 145만의 |c00AC59FF절대 데미지|r를 입힙니다.";
-- anam
...
-- aub1 1
		t["A0JF"][5][1] = "사용시 20 + 라운드 수*4만큼의 골드를 획득합니다. Cooldown 60초";
-- anam
-- aart
...
-- aub1 2
		t["A0JF"][25][1] = "사용시 20 + 라운드 수*4만큼의 골드를 획득합니다. Cooldown 57초";
-- aub1 3
		t["A0JF"][26][1] = "사용시 20 + 라운드 수*4만큼의 골드를 획득합니다. Cooldown 54초";
-- aub1 4
		t["A0JF"][27][1] = "사용시 20 + 라운드 수*4만큼의 골드를 획득합니다. Cooldown 51초";
-- aub1 5
		t["A0JF"][28][1] = "사용시 20 + 라운드 수*4만큼의 골드를 획득합니다. Cooldown 48 seconds";
-- aub1 6
		t["A0JF"][29][1] = "사용시 20 + 라운드 수*4만큼의 골드를 획득합니다. Cooldown 45 seconds";
-- aub1 7
		t["A0JF"][30][1] = "사용시 20 + 라운드 수*4만큼의 골드를 획득합니다. Cooldown 42초";
-- aub1 8
		t["A0JF"][31][1] = "사용시 20 + 라운드 수*4만큼의 골드를 획득합니다. Cooldown 39초";
-- aub1 9
		t["A0JF"][32][1] = "사용시 20 + 라운드 수*4만큼의 골드를 획득합니다. Cooldown 35 seconds";
-- [A0JI]
-- anam
-- atp1 1
...
-- aub1 1
		t["A0JV"][6][1] = "*세이자가 공격시 10% 확률로 대상 지점 주변 400범위 적을 2.5 seconds간 스턴시키고, 75만의 |c00379BFF마법 데미지|r를 입힙니다.";
-- aart
...
*마나가 200이 됐을 경우에 발동하며, 레밀리아가 있는 위치에 거대한 요력을 십자가 형태로 생성합니다. 이 십자가는 2.5 seconds간 지속되며, 0.5 seconds마다 대상 지점 650범위 내에 있는 Units을 0.5 seconds간 스턴시키며 40만의 마법 데미지를 입힙니다.";
-- aub1 3
-- aub1 4
-- aub1 5
-- aub1 6
...
*마나가 300이 됐을 경우에 발동하며, 레밀리아가 있는 위치에 거대한 요력을 십자가 형태로 생성합니다. 이 십자가는 2.5 seconds간 지속되며, 0.5 seconds마다 대상 지점 내에 있는 Units을 0.5 seconds간 스턴시키며 40만의 마법 데미지를 입힙니다.";
-- aub1 13
-- aub1 14
-- aub1 15
-- aub1 16
...
-- aub1 1
		t["A06U"][5][1] = "|c00A8F13A[Combination]|r: Kanako Yasaka[Epic] + 사나에[Unique] + Unique 소울 * 2 + 신비술사의 고서\r\
...
\r\
|c00FFFF00눈을 뜸|r : 자신 주변 1000범위에 현재 체력의 4%의 |c00FF6464물리 데미지|r와 5 seconds간 Attack Speed 30% 증가 효과\r\
|c00FFFF00눈을 감음|r : 자신 주변 1000범위에 185만의 |c00FF6464물리 데미지|r와 4.5 seconds의 스턴 효과.";
-- anam
-- abuf 1
		t["S008"][6][1] = "B03A";
-- atat
...
-- aub1 1
		t["A0H5"][5][1] = "*공격시 10% 확률로 대상 주변 650범위 내의 적에게 125만의 |c00FF6464물리 데미지|r를 입히고, 1.5 seconds간 기절시킵니다.\r\
|c00FF712D[허영갑주]|r + 3\r\
...
*자신의 위치에 700범위를 감싸며 5 seconds간 지속되는 결계를 생성합니다. 결계 내의 적은 받는 데미지의 25%를 |c00AC59FF절대 데미지|r로 추가로 입습니다.";
-- [A0LQ]
-- aart
-- arac
-- anam
...
*우츠호가 초신성으로 변합니다. 초신성으로 변한 우츠호는 아무런 행동을 하지 못하며, 주변 1000범위 적에게 초당 전체 체력의 3% + 200만의 |c00FF6464물리 데미지|r를 입힙니다. 초신성은 5 seconds간 지속되며, 초신성에서 부활한 우츠호는 마나를 모두 회복하고, 『야타가라스 다이브』의 Cooldown이 초기화됩니다.\r\
...
-- aub1 1
		t["A0GT"][6][1] = "*우츠호가 공격시 10% 확률로 자신의 제어봉에서 칼날 형태의 빔을 발사합니다. 900거리 250범위 내에 있는 적에게 현재 체력의 0.9% + 90만의 |c00FF6464물리 데미지|r를 입히고, 1.8 seconds간 스턴시킵니다.\r\
...
*공격시 25% 확률로 바람의 기운을 담은 검으로 적을 베어 60만의 |c00379BFF마법 데미지|r와 60만의 |c00AC59FF절대 데미지|r를 입히고 1.5 seconds간 기절시킵니다.";
-- atp1 2
		t["A03X"][9][1] = "『재넘이』";
-- aub1 2
...
-- aub1 1
		t["A03J"][3][1] = "＊|c0044BBFF[마력]|r - 100 : 공격 시 마력 2 회복, Namazu가 격렬하게 철벅거려 자신주변 500 범위의 적에게 전체 체력 2% + 300만의 |c00FF6464물리 피해|r를 가합니다.\r\
|c00FF712D[허영갑주]|r + 15";
-- anam
-- aart
...
-Sho Toramaru우[Epic],Nue Houjuu[Epic] -> |c00FF6464물리 데미지|r의 Murasa로 변경";
-- aart
...
-- aub1 1
		t["A07M"][3][1] = "*유카리가 공격시 10% 확률로 경계를 열어 적을 포격합니다. 대상 주변 500범위 적에게 전체 체력의 [0.2%~0.4%]의 마법 데미지를 입히고, 2.5 seconds간 스턴시킵니다.";
-- anam
-- aart
-- atp1 2
-- atp1 3
...
-- aub1 1
		t["A07O"][5][1] = "*유카리가 공격시 마나를 1씩 회복합니다. 마나가 145가 됐을때 고속비행물체를 생성하여 대상 지점 750범위를 빠르게 이동시킵니다. 범위 내의 적은 0.1초마다 10만의 마법 데미지를 입습니다. 비행 물체는 2.5 seconds간 지속되며, 이동을 끝내고 난 후 폭발하여 적 전체 체력의 4% + 550만에 해당하는 |c00379BFF마법 데미지|r를 입힙니다.";
-- arac
-- [S00C]
-- atar 1
...
*네로가 공격시 25% 확률로 대상 Units을 1.5 seconds간 스턴시키고, 45만의 마법 데미지를 입힙니다. 보스일 경우, 현재 체력의 0.2%의 마법 데미지가 추가됩니다.\r\
...
*공격시 10% 확률로 대상 주변 450범위에 현재 체력의 0.5% + 85만의 |c00FF6464물리 데미지|r를 입히고 1.5 seconds간 스턴시키며, 마나를 2 회복합니다.\r\
...
＊공격당한 대상이 보스라면, 공격 시 40% 확률로 45만의 |c00379BFF마법 피해|r를 가하고 1.5 seconds간 기절시킵니다.\r\
...
＊공격당한 적의 체력이 90% 이상이라면, 체력을 90%로 만듭니다.\r\
＊공격 시 10% 확률로 대상 주변 450 범위의 적에게 70만의 |c00379BFF마법 피해|r를 가하고 1.2초간 기절시킵니다.\r\
＊공격당한 대상이 보스라면, 공격 시 40% 확률로 45만의 |c00379BFF마법 피해|r를 가하고 1.5 seconds간 기절시킵니다.";
-- atar 1
-- atp1 1
...
*공격시 40% 확률로 대상 보스 Units에게 45만의 |c00379BFF마법 데미지|r를 입히고, 1.5 seconds간 스턴시킵니다.";
-- aub1 3
-- aub1 4
-- aub1 5
-- aub1 6
...
＊공격 시 11% 확률로 대상 발밑에 회오리바람이 몰아쳐 주변 450 범위의 적에게 75만의 |c00379BFF마법 피해|r를 가하고 1.8 seconds간 기절시킵니다.\r\
...
*코코로가 공격시 10% 확률로 전방 900거리 300범위 내에 있는 적에게 275만의 |c00FF6464물리 데미지|r를 입히고, 2.5 seconds간 스턴시킵니다.";
-- [A0C7]
-- arac
-- anam
-- atar 1
...
*Cirno가 공격시 10% 확률로 대상 주변 600범위 Units에게 65만의 |c00379BFF마법 데미지|r를 입히고, 3.5 seconds간 스턴시킵니다.\r\
ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ\r\
빙부『아이시클 머신건』\r\
\r\
*공격시 30% 확률로 대상 Units을 2.5 seconds간 스턴시키고, 전체 체력의 3% + 250만의 |c00379BFF마법 데미지|r를 입힙니다.\r\
...
-- aub1 1
		t["A03Z"][5][1] = "*공격시 20% 확률로 네무노가 자신의 칼을 날카롭게 갈아냅니다. 칼을 갈아낸 후 첫번째 공격은 적 전체 체력의 12%의 |c00FF6464물리 데미지|r를 입히고 1.5 seconds간 스턴시킵니다. \r\
...
-- atp1 1
		t["A0A7"][4][1] = "『마운틴 머더』";
-- aub1 1
		t["A0A7"][5][1] = "*네무노의 마나가 100이 됐을때 5 seconds간 광폭화 상태로 돌입합니다. 칼을 갈아낼 확률이 20% 증가합니다. 추가로 Attack Speed가 35% 증가합니다. 1초마다 네무노가 서있는 위치에서 땅이 흔들려 주변 700범위 적에게 현재 체력의 0.5% + 35만의 |c00FF6464물리 데미지|r를 입힙니다. \r\
...
*자신의 위치에 태양을 형상화한 탄막을 생성하여 2.5 seconds 뒤 폭발시킵니다. 태양 주변 800범위 적에게 750만의 |c00379BFF마법 데미지|r를 입힙니다.\r\
*로열 플Rare에 휘말린 적은 마법에 대항할 능력을 잃어버려 5 seconds간 마법 데미지를 40% 증폭하여 받습니다.";
-- aub1 2
		t["A0N7"][9][1] = "*공격시 마나를 1 회복합니다. 마나가 200이 됐을때 발동합니다.\r\
*대상 지점을 회전하는 2개의 탄막을 생성합니다. 탄막 내부의 적은 1초마다 1.5 seconds간 스턴당합니다. 탄막은 총 6초간 유지되며, 내부의 적에게 초당 200만의 |c00379BFF마법 데미지|r를 입힙니다.\r\
...
*마나가 120이 됐을때 대상 800범위 지점을 별빛의 검기로 베어냅니다. 별빛의 검기로 베어진 적은 1.5 seconds간 스턴당하며 공격한 적의 전체 체력의 2.5% + 300만의 |c00FF6464물리 데미지|r를 입습니다. 별빛의 검기가 사라지고 난 후 3초 후에 후속타로 별빛을 폭발시켜 검기가 있던 위치에서 800범위에 있는 적들에게 150만의 |c00FF6464물리 데미지|r를 추가로 입힙니다.\r\
...
-- aub1 1
		t["A0NE"][5][1] = "Komachi Onozuka[Unique] + 시키에이키 야마자나두[Epic] + Unique 소울 1개";
-- atp1 1
...
*대상 Units의 현재 체력의 0.4% + 100만의 |c00AC59FF절대 데미지|r를 대상 주변 500범위에 입히고, 1.5 seconds간 스턴시킵니다. ";
-- anam
-- aart
...
*대상 Units의 전체 체력의 0.4% + 100만의 |c00AC59FF절대 데미지|r를 대상 주변 500범위에 입히고, 1.5 seconds간 스턴시킵니다. ";
-- abuf 1
		t["A0O8"][9][1] = "Bwea";
-- atar 2
-- abuf 2
...
*공격시 18% 확률로 대상 주변 400범위 적에게 185만의 |c00AC59FF절대 데미지|r를 입히고, 1.5 seconds의 스턴을 입힙니다.";
-- anam
-- atar 1
...
-- atp1 2
-- aub1 2
		t["A092"][8][1] = "Phantom Ensemble 주변 650범위 적군의 방어력을 14% 감소시킵니다. 공격시 10% 확률로 자신 주변 650범위에 12만의 절대 데미지를 입힙니다.";
-- abuf 1
-- atar 2
-- abuf 2
		t["A092"][11][1] = "B049";
...
*유유코가 공격시 10% 확률로 대상 지점에 벚꽃잎을 퍼뜨려 450범위 내에 있는 적에게 현재 체력의 0.3% + 60만의 |c00AC59FF절대 데미지|r를 입히고, 1.5 seconds간 스턴시킵니다.";
-- atar 1
...
*유기가 공격시 8% 확률로 큰 함성을 지릅니다. 자신 주변 750범위의 적에게 200만의 |c00FF6464물리 데미지|r를 입힙니다. 추가로 자신 주변 1000범위 아군의 공격력을 5 seconds간 75% 상승시킵니다.\r\
...
＊|c002C62EA[[마력]|r - 140 : 공격 시 마력 1 회복, 거대한 어둠의 구체를 만들고 폭발시켜 대상 주변 600 범위의 적에게 전체 체력 2.5% + 275만의 |c00FF6464물리 피해|r를 가하고 5 seconds간 Movement Speed를 80% 감소시키며, 1.5 seconds간 기절시킨다.";
-- anam
-- aart
-- atp1 2
...
*Rumia가 공격시 마나를 1씩 회복합니다. 마나가 140이 됐을때, 대상 지점에 거대한 어둠의 구체를 만들어 폭발시킵니다. 구체 주변 600범위 내에 있는 적에게 5 seconds간 80%의 Movement Speed 감소 효과를 입히고, 1.5 seconds간 기절시키며 전체 체력의 2.5% + 275만의 |c00FF6464물리 데미지|r를 입힙니다.";
-- abuf 1
		t["A0PX"][9][1] = "B05N";
-- atar 2
-- abuf 2
...
*공격시 12% 확률로 대상 지점에 격류를 생성합니다. 대상 지점 주변 400범위 적을 1.8 seconds간 스턴시키고 전체 체력의 0.4% + 잃은 체력의 0.6% + 135만의 |c00FF6464물리 데미지|r를 입힙니다.";
-- abuf 1
		t["A0QH"][8][1] = "B061";
-- atar 2
-- abuf 2
...
-- atp1 2
-- aub1 2
		t["A027"][10][1] = "|c00A8F13A[Combination]|r: Tokiko[Epic] + Marisa Kirisame[Unique] + 신비술사의 고서\r\
\r\
[Attack Speed]: 0.5 Cooldown\r\
[Movement Speed]: 300\r\
|c00F8BA54[Upgrade]|r : Arcana Units Upgrade";
...
-- atp1 31
-- aub1 2
		t["A04A"][36][1] = "*케이네가 공격한 대상 Units의 체력이 10% 이하라면 발동합니다. 공격시 15% 확률로Instantly kills a target unit. 공격한 대상 Units의 체력이 70% 이상이라면 대상 전체 체력의 15%의 물리 데미지를 입힙니다.\r\
미션,스토리 보스에게는 적용되지 않습니다.";
-- aub1 3
-- aub1 4
-- aub1 5
...
＊공격 시 10% 확률로 대상 주변 400 범위에 격류를 일으켜 적에게 70만의 |c00FF6464물리 피해|r를 가하고 2초간 기절시킴과 동시에 5 seconds간 Movement Speed를 35% 감소시킵니다.";
-- anam
-- aart
-- atp1 2
-- aub1 2
...
*대상 지점 400범위 내에 있는 적의 Movement Speed를 5 seconds간 60% 감소시키고 대상 적 Units 하나에게 전체 체력의 10%에 해당하는 |c00FF6464물리 데미지|r를 입힙니다.[보스 200만]\r\
ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ\r\
『밀도를 조종하는 정도의 능력』\r\
\r\
...
*텐시가 대상 지점에 요석을 떨어뜨려 500범위 적을 5 seconds간 스턴시키고 [600만~1000만]의 |c00379BFF마법 데미지|r를 입힙니다.\r\
...
-- aub1 1
		t["A0HS"][5][1] = "|c00A8F13A[Combination]|r: 시키에이키 야마자나두[Epic] + Sho Toramaru[Epic] + Unique 소울 * 2 + 신비술사의 고서\r\
...
＊|c0044BBFF[마력]|r - 70 : 공격 시 마력 1~2 회복, 음양옥을 대상 위치에 던져 주변 350 범위의 적에게 전체 체력 1% + 350만의 |c00FF6464물리 피해|r를 가하고 2.5 seconds간 기절시킵니다.";
-- anam
-- aart
-- atat
-- abuf 1
...
영부『몽상봉인』\r\
＊레이무의 공격은 전방의 적에게 피해를 가합니다.\r\
＊|c0044BBFF[마력]|r - 70 : 공격 시 마력 2~4 회복, 음양옥을 대상 위치에 던져 주변 350 범위의 적에게 전체 체력 2% + 700만의 |c00FF6464물리 피해|r를 가하고 2.5 seconds간 기절시킵니다.";
-- atp1 3
		t["A0QY"][13][1] = "주부『명주암투』";
-- aub1 3
		t["A0QY"][14][1] = "＊|c0044BBFF[마력]|r - 70 : 공격 시 마력 1~2 회복, 음양옥을 대상 위치에 던져 주변 350 범위의 적에게 전체 체력 1% + 350만의 |c00FF6464물리 피해|r를 가하고 2.5 seconds간 기절시킵니다.";
-- atar 3
-- aub1 4
-- [A0QZ]
-- aart
...
-- arac
-- aub1 1
		t["A0R1"][7][1] = "Hakurei Reimu[Unique] + Yakumo Ran[Epic] + Nue Houjuu[Epic] + Unique 소울 5개";
-- ahky
-- atat
		t["A0R1"][11][1] = "nmgd";
-- alig
...
-- atp1 1
-- aub1 1
		t["A0RD"][3][1] = "*Cirno가 공격시 마나를 9 회복합니다. 마나가 999가 됐을때, 자신 주변 900범위 적의 다리를 얼려 5 seconds간 기절시킵니다. 이 효과를 받은 적은 이후 마법 데미지를 20% 증폭하여 받습니다.";
-- atar 2
-- atar 3
-- atar 4
-- arac
...
-- aspt
-- aub1 1
		t["A0RN"][7][1] = "*Rumia가 공격시 11% 확률로 자신의 마검을 휘둘러 전방 900거리 200범위 내에 있는 적에게 현재 체력의 0.3% + 150만의 |c00FF6464물리 데미지|r를 입히고 1.5 seconds간 기절시킵니다.\r\
...
-- aub1 2
		t["A06E"][97][1] = "*공격시 14% 확률로 Murasa의 주변 450범위에 물을 터뜨립니다. 터진 물은 적에게 120만의 |c00FF6464물리 데미지|r를 입히고, 1.5 seconds간 스턴시킵니다.\r\
...
-- atp1 31
-- aub1 2
		t["A0RT"][35][1] = "*공격시 12% 확률로 불을 치솟게 해 대상 Units 주변 400범위 내에 있는 적에게 120만의 |c00379BFF마법 데미지|r와 1.5 seconds의 스턴을 입힙니다.";
-- aub1 3
...
*공격 시 10% 확률로 자신의 신력을 해방시켜 대상 주변 400범위 적에게 잃은 체력의 1% + 100만의 |c00FF6464물리 피해|r를 가하고 1.5 seconds간 기절시킵니다.\r\
|c00FF712D[허영갑주]|r + 3";
-- anam
-- abuf 1
-- aart
...
-- atp1 1
		t["A0BU"][2][1] = "『환시 - 경계』";
-- aub1 1
		t["A0BU"][3][1] = "*공격시 [|c000080FF8%|r] 확률로 메리 주변 600범위 경계를 뒤틀어 적을 (1.5 seconds ~ 3.5 seconds)간 기절시키고, 전체 체력의 (0.5~1.5)% + 150만의 |c00FF6464물리 데미지|r를 입힙니다.\r\
...
-- atp1 31
-- aub1 2
		t["A0BU"][36][1] = "*공격시 [|c000080FF9%|r] 확률로 메리 주변 600범위 경계를 뒤틀어 적을 (1.5 seconds ~ 3.5 seconds)간 기절시키고, 전체 체력의 (0.5~1.5)% + 150만의 |c00FF6464물리 데미지|r를 입힙니다.\r\
*이 스킬이 발동되었을때, 메리의 활력 Cooldown이 1초 감소합니다.";
-- aub1 3
		t["A0BU"][37][1] = "*공격시 [|c000080FF10%|r] 확률로 메리 주변 600범위 경계를 뒤틀어 적을 (1.5 seconds ~ 3.5 seconds)간 기절시키고, 전체 체력의 (0.5~1.5)% + 150만의 |c00FF6464물리 데미지|r를 입힙니다.\r\
*이 스킬이 발동되었을때, 메리의 활력 Cooldown이 1초 감소합니다.";
-- aub1 4
		t["A0BU"][38][1] = "*공격시 [|c000080FF11%|r] 확률로 메리 주변 600범위 경계를 뒤틀어 적을 (1.5 seconds ~ 3.5 seconds)간 기절시키고, 전체 체력의 (0.5~1.5)% + 150만의 |c00FF6464물리 데미지|r를 입힙니다.\r\
*이 스킬이 발동되었을때, 메리의 활력 Cooldown이 1초 감소합니다.";
-- aub1 5
		t["A0BU"][39][1] = "*공격시 [|c00FABE2112%|r] 확률로 메리 주변 600범위 경계를 뒤틀어 적을 (1.5 seconds ~ 3.5 seconds)간 기절시키고, 전체 체력의 (0.5~1.5)% + 150만의 물리 데미지를 입힙니다.\r\
*이 스킬이 발동되었을때, 메리의 활력 Cooldown이 1초 감소합니다.";
-- aub1 6
		t["A0BU"][40][1] = "*공격시 [|c00FABE2113%|r] 확률로 메리 주변 600범위 경계를 뒤틀어 적을 (1.5 seconds ~ 3.5 seconds)간 기절시키고, 전체 체력의 (0.5~1.5)% + 150만의 물리 데미지를 입힙니다.\r\
*이 스킬이 발동되었을때, 메리의 활력 Cooldown이 1초 감소합니다.";
-- aub1 7
		t["A0BU"][41][1] = "*공격시 [|c00FABE2114%|r] 확률로 메리 주변 600범위 경계를 뒤틀어 적을 (1.5 seconds ~ 3.5 seconds)간 기절시키고, 전체 체력의 (0.5~1.5)% + 150만의 물리 데미지를 입힙니다.\r\
*이 스킬이 발동되었을때, 메리의 활력 Cooldown이 1초 감소합니다.";
-- aub1 8
		t["A0BU"][42][1] = "*공격시 [|c00FFA6FF15%|r] 확률로 메리 주변 600범위 경계를 뒤틀어 적을 (1.5 seconds ~ 3.5 seconds)간 기절시키고, 전체 체력의 (0.5~1.5)% + 150만의 물리 데미지를 입힙니다.\r\
*이 스킬이 발동되었을때, 메리의 활력 Cooldown이 1초 감소합니다.";
-- aub1 9
-- aub1 11
-- aub1 10
...
*체력을 모두 회복시켰을 경우, 대상 Units 주변 600범위에 전체 체력의 (3~5%) + 500만의 |c00379BFF마법 데미지|r를 입히고, 자신의 마나를 (15~50%) 회복합니다.";
-- aub1 4
		t["A0MK"][38][1] = "*공격시 [|c00008FD511%|r] 확률로 메리 주변 600범위 경계를 뒤틀어 적을 <1.5 seconds ~ 3.5 seconds>간 기절시키고, 전체 체력의 <0.5~1.5>% + 150만의 물리 데미지를 입힙니다.\r\
*이 스킬이 발동되었을때, 메리의 활력 Cooldown이 1초 감소합니다.";
-- aub1 5
		t["A0MK"][39][1] = "*공격시 [|c00FCAE1D12%|r] 확률로 메리 주변 600범위 경계를 뒤틀어 적을 <1.5 seconds ~ 3.5 seconds>간 기절시키고, 전체 체력의 <0.5~1.5>% + 150만의 물리 데미지를 입힙니다.\r\
*이 스킬이 발동되었을때, 메리의 활력 Cooldown이 1초 감소합니다.";
-- aub1 6
		t["A0MK"][40][1] = "*공격시 [|c00FCAE1D13%|r] 확률로 메리 주변 600범위 경계를 뒤틀어 적을 <1.5 seconds ~ 3.5 seconds>간 기절시키고, 전체 체력의 <0.5~1.5>% + 150만의 물리 데미지를 입힙니다.\r\
*이 스킬이 발동되었을때, 메리의 활력 Cooldown이 1초 감소합니다.";
-- aub1 7
		t["A0MK"][41][1] = "*공격시 [|c00FCAE1D14%|r] 확률로 메리 주변 600범위 경계를 뒤틀어 적을 <1.5 seconds ~ 3.5 seconds>간 기절시키고, 전체 체력의 <0.5~1.5>% + 150만의 물리 데미지를 입힙니다.\r\
*이 스킬이 발동되었을때, 메리의 활력 Cooldown이 1초 감소합니다.";
-- aub1 8
		t["A0MK"][42][1] = "*공격시 [[|c00BF00FF1c00FF80404%r]] 확률로 메리 주변 600범위 경계를 뒤틀어 적을 <1.5 seconds ~ 3.5 seconds>간 기절시키고, 전체 체력의 <0.5~1.5>% + 150만의 물리 데미지를 입힙니다.\r\
*이 스킬이 발동되었을때, 메리의 활력 Cooldown이 1초 감소합니다.";
-- aub1 9
-- aub1 11
-- aub1 10
...
-- aub1 1
		t["A0SO"][2][1] = "＊|c0044BBFF[마력]|r - 130 : 대상에게 각인을 5 seconds 동안 새겨 대상 주변 450 범위의 적에게 0.5 seconds마다 전체 체력 0.2% + 50만의 |c00379BFF마법 피해|r를 가합니다. 만약 각인된 대상이 사망한다면, 전체 체력 5.5% + 100만의 |c00379BFF마법 피해|r를 가하고 자신의 마력을 25% 회복합니다.";
-- anam
-- aart
-- atar 1
-- [A0SP]
...
-- [A0SU]
-- atp1 1
		t["A0SU"][1][1] = "|c00FEE952[Unit Information]|r - 히메카이도 하타테[Ascended]";
-- anam
-- aart
-- atp1 2
-- atp1 3
...
＊공격 시 10% 확률로 자신 주변 750 범위의 적에게 5만의 |c00379BFF마법 피해|r를 가하고 0.5 seconds간 기절시킨다.";
-- atar 2
-- atp1 2
-- aub1 2
-- abuf 2
...
-- aub1 1
		t["A0TO"][3][1] = "＊공격 시 9% 확률로 마계의 기운을 퍼뜨려 자신 주변 700 범위의 적에게 현재 체력 1%의 |c00FF6464물리|r + 현재 체력 1%의|c00379BFF마법|r 피해를 가하고 1.5 seconds간 기절시킵니다.";
-- atar 2
-- atar 3
-- atar 4
-- arac
...
-- atp1 2
-- aub1 2
		t["A0TO"][17][1] = "＊공격 시 9% 확률로 마계의 기운을 퍼뜨려 자신 주변 700 범위의 적에게 현재 체력 1%의 |c00FF6464물리|r + 현재 체력 1%의 |c00379BFF마법|r 피해를 가하고 1.5 seconds간 기절시키고 받는 마법 피해를 45% 증폭시킵니다.\r\
|c00FF712D[허영갑주]|r + 60";
-- [A0TR]
-- arac
-- atar 1
...
-- arac
-- aub1 1
		t["A0UT"][2][1] = "|c00A8F13A[Combination]|r: Namazu[Epic] + Yatadera Narumi[Unique] + 신비술사의 고서\r\
...
-- aub1 1
		t["A0UY"][4][1] = "＊[사용식 능력] : 환상향을 정화시켜 더러움을 없애고 완전무결한 땅으로 만듭니다. 자신 주변 700 범위의 적에게 현재 체력 15%의 |c00AC59FF절대 피해|r를 가하고, 월인을 제외한 맵 전체의 자신 소유 Units을 5 seconds간 기절시킵니다. Cooldown 300초";
-- ahky
-- areq
-- Ncl6G1
		t["A0UY"][7][1] = "d";
