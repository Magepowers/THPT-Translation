...
＊|c0044BBFF[마력]|r - 80 : 공격 시 마력 1 회복, 대상 주변 600 범위에 10,000의 |c00379BFF마법 피해|r를 가하고 1초간 기절시킵니다.";
-- [ACnr]
-- anam
-- atar 1
...
[50라운드 이후부터 하타테가 본격적인 취재에 나섭니다. 『텐구 사이코그래피』의 활력 Cooldown이 10초에서 6초로 감소합니다.]\r\
...
-- anam
-- aub1 1
		t["AEbl"][8][1] = "*사용식 능력 : 레밀리아가 맵 전체 어디든 이동합니다. [Cooldown 20초]\r\
...
*자신의 로스트 Cooldown이 15 seconds에서 10초로 감소합니다.";
-- anam
...
-- aub1 1
		t["A02R"][3][1] = "＊|c002C62EA[마력]|r - 135 : 공격 시 마력 1 회복, 자신의 뒤에서 유령선을 호출하여 목표 지점 400 범위를 4초 동안 포격합니다. 1초마다 전체 체력 1.5% + 200,000의 |c00379BFF마법 피해|r를 가합니다.";
-- anam
-- aart
-- [A02T]
-- arac
...
-- [A04B]
-- aub1 1
		t["A04B"][1][1] = "＊|c0044BBFF[마력]|r - 60 : 공격 시 마력 4 회복, 자신 주변 700 범위의 적을 정화해 받는 마법 피해를 20% |c0000FFFF증폭|r시키고, 2.5 seconds + [라운드/100]초간 기절시킵니다.";
-- areq
		t["A04B"][2][1] = "h04N";
-- anam
-- atp1 1
...
*Attack Speed가 100%가 됐을때, 사쿠야가 자신의 시간을 10초간 정지시킵니다. 정지시간 동안『이터널 믹』의 Movement Speed 감소 효과가 80%로 적용되며, 『소울 스컬쳐』의 방어력 감소치가 40으로 증가하고, Current Health 비례 데미지가 3%에서 4%로 상승합니다. 정지시간이 종료되면 Attack Speed 상승치가 초기화됩니다.";
-- abuf 2
-- atar 2
-- atp1 2
-- aub1 2
...
-- aub1 1
		t["A063"][3][1] = "＊|c0044BBFF[마력]|r - 90 : 공격 시 마력 1 회복, 대상 주변 600 범위의 적을 심판해 전체 체력의 2% + 300,000의 |c00379BFF마법 피해|r를 가합니다. 만약 자신의 Units 카운트가 기본 게임 오버 카운트의 절반 이상이라면, 피해가 2배로 증가합니다.\r\
...
*|c00C5EA53[Combination Synergy]|r영원한 환생의 불꽃\r\
-Kamishirasawa Keine EX[Epic]를 보유하고 있을 경우, 활력 Cooldown이 10초 감소합니다.";
-- aub1 12
-- aub1 13
-- aub1 14
-- aub1 15
...
-- aub1 1
		t["A096"][3][1] = "＊[마력] - 180 : 공격 시 마력 1 회복, 보이지 않는 살의를 소환해 마법 방어력을 제거하는 공격을 합니다. 공격한 적의 체력이 10% 이하라면, 즉사시키고 5 seconds간 유지되는 살의를 하나 더 소환합니다. 첫 살의가 지속되는 동안 스킬을 다시 발동할 수 없습니다.\r\
...
-- atp1 31
-- aub1 2
		t["A096"][36][1] = "＊[마력] - 180 : 공격 시 마력 1 회복, 보이지 않는 살의를 소환해 마법 방어력을 제거하는 공격을 합니다. 공격한 적의 체력이 10% 이하라면, 즉사시키고 5 seconds간 유지되는 살의를 하나 더 소환합니다. 첫 살의가 지속되고 있어 스킬을 발동할 수 없습니다.\r\
-공격력(|c00379BFF마법|r) : Current Health 5%(보스는 0.5%)\r\
-Attack Speed : 0.5 Cooldown";
-- aub1 3
...
-- aub1 12
		t["A09Z"][46][1] = "매 공격시 20% 확률로 10초동안 피닉스를 소환해서 공격한 대상에게 돌진시킵니다. 피닉스는 522의 속도로 돌진하며, 돌진하는동안 주변에 있는 적에게 0.2초당 3,000의 데미지를 주는 불꽃을 발사합니다. 공격한 Units에게 부딫힐경우 265000의 데미지와 3초의 스턴을 주변에 주지만, 그렇지않을시 그냥 사라집니다.";
-- aub1 13
		t["A09Z"][47][1] = "매 공격시 20% 확률로 10초동안 피닉스를 소환해서 공격한 대상에게 돌진시킵니다. 피닉스는 522의 속도로 돌진하며, 돌진하는동안 주변에 있는 적에게 0.2초당 3,000의 데미지를 주는 불꽃을 발사합니다. 공격한 Units에게 부딫힐경우 280000의 데미지와 3초의 스턴을 주변에 주지만, 그렇지않을시 그냥 사라집니다.";
-- aub1 14
		t["A09Z"][48][1] = "매 공격시 20% 확률로 10초동안 피닉스를 소환해서 공격한 대상에게 돌진시킵니다. 피닉스는 522의 속도로 돌진하며, 돌진하는동안 주변에 있는 적에게 0.2초당 3,000의 데미지를 주는 불꽃을 발사합니다. 공격한 Units에게 부딫힐경우 295000의 데미지와 3초의 스턴을 주변에 주지만, 그렇지않을시 그냥 사라집니다.";
-- aub1 15
		t["A09Z"][49][1] = "매 공격시 20% 확률로 10초동안 피닉스를 소환해서 공격한 대상에게 돌진시킵니다. 피닉스는 522의 속도로 돌진하며, 돌진하는동안 주변에 있는 적에게 0.2초당 3,000의 데미지를 주는 불꽃을 발사합니다. 공격한 Units에게 부딫힐경우 310000의 데미지와 3초의 스턴을 주변에 주지만, 그렇지않을시 그냥 사라집니다.";
-- aub1 16
		t["A09Z"][50][1] = "매 공격시 20% 확률로 10초동안 피닉스를 소환해서 공격한 대상에게 돌진시킵니다. 피닉스는 400의 속도로 돌진하며, 돌진하는동안 주변에 있는 적에게 0.2초당 3,000의 데미지를 주는 불꽃을 발사합니다. 공격한 Units에게 부딫힐경우 325000의 데미지와 3초의 스턴을 주변에 주지만, 그렇지않을시 그냥 사라집니다.";
-- aub1 17
-- aub1 18
-- aub1 19
-- aub1 20
...
*선위에 있는 적은 1초마다 전체 체력의 0.4% + 50,000의 |c00379BFF Magical Damage|r를 입습니다. 선은 10초간 지속됩니다.";
-- anam
-- aart
-- atp1 2
-- atp1 3
...
-- aub1 1
		t["A0AK"][4][1] = "대상 Magic Units을 기존의 Normal Units으로 분해시킵니다. 100골드가 소모됩니다. Cooldown 40초";
-- aart
...
-- aub1 1
		t["A09Y"][4][1] = "*대상 적 Units의 Movement Speed를 5 seconds간 50%만큼 감소시키고, 방어력을 45,000큼 10초간 감소시킵니다.\r\
...
-- atar 8
-- aub1 1
		t["A0AZ"][26][1] = "목표 적군의 아머가 45,000큼 감소합니다. 60초간 지속됩니다. 쿨타임 200초|cffffcc00(다음 레벨 제한 : 10웨이브)|r";
-- aub1 2
		t["A0AZ"][27][1] = "목표 적군의 아머가 22,000큼 감소합니다. 60초간 지속됩니다. 쿨타임 190초|cffffcc00(다음 레벨 제한 : 20웨이브)|r";
-- aub1 3
		t["A0AZ"][28][1] = "목표 적군의 아머가 35,000큼 감소합니다. 60초간 지속됩니다. 쿨타임 180초|cffffcc00(다음 레벨 제한 : 30웨이브)|r";
-- aub1 4
		t["A0AZ"][29][1] = "목표 적군의 아머가 50,000큼 감소합니다. 60초간 지속됩니다. 쿨타임 170초|cffffcc00(다음 레벨 제한 : 40웨이브)|r";
-- aub1 5
		t["A0AZ"][30][1] = "목표 적군의 아머가 68,000큼 감소합니다. 60초간 지속됩니다. 쿨타임 160초|cffffcc00(다음 레벨 제한 : 50웨이브)|r";
-- aub1 6
		t["A0AZ"][31][1] = "목표 적군의 아머가 88,000큼 감소합니다. 60초간 지속됩니다. 쿨타임 150초|cffffcc00(다음 레벨 제한 : 60웨이브)|r";
-- aub1 7
		t["A0AZ"][32][1] = "목표 적군의 아머가 110,000큼 감소합니다. 60초간 지속됩니다. 쿨타임 140초|cffffcc00(다음 레벨 제한 : 70웨이브)|r";
-- aub1 8
		t["A0AZ"][33][1] = "목표 적군의 아머가 132,000큼 감소합니다. 60초간 지속됩니다. 쿨타임 130초";
-- auhk
-- ahky
-- auu1 1
...
-- atp1 9
-- aub1 9
		t["A0AZ"][57][1] = "목표 적군의 아머가 150,000큼 감소합니다. 60초간 지속됩니다. 쿨타임 130초";
-- [A0B0]
-- anam
		t["A0B0"][1][1] = "[F3]향림당_D";
-- arac
...
-- aub1 4
		t["A0CP"][17][1] = "공격시 10%확률로 자신의 필드 중앙에 신령묘를 세워 자신의 필드 전체에 0.8 seconds마다 74000의 데미지를 줍니다. 10초간 지속됩니다. 중복 발동 안함.";
-- aub1 5
		t["A0CP"][18][1] = "공격시 10%확률로 자신의 필드 중앙에 신령묘를 세워 자신의 필드 전체에 0.8 seconds마다 78000의 데미지를 줍니다. 10초간 지속됩니다. 중복 발동 안함.";
-- aub1 6
...
-- aub1 10
		t["A0CP"][23][1] = "공격시 10%확률로 자신의 필드 중앙에 신령묘를 세워 자신의 필드 전체에 0.5 seconds마다 86000의 데미지를 줍니다. 10초간 지속됩니다. 중복 발동 안함.";
-- aub1 11
		t["A0CP"][24][1] = "공격시 10%확률로 자신의 필드 중앙에 신령묘를 세워 자신의 필드 전체에 0.5 seconds마다 90000의 데미지를 줍니다. 10초간 지속됩니다. 중복 발동 안함.";
-- arac
-- [A0CT]
-- anam
-- atp1 1
...
-- aart
-- aub1 1
		t["A0H8"][10][1] = "야고코로 제약의 손을 거친 최상의 자연인의 정기로 만들어진 특수 피로 회복제. 먹으면 왠지 운지라고 외치고 싶어지지만 효과하나는 뛰어나다. 피로가 말끔히 사라지고 전투능력이 증가한다. 공격력 80%상승. 지속 15 seconds, 쿨타임 150초.";
-- aut1 1
...
-- aub1 1
		t["A0H9"][9][1] = "야고코로 제약사에서 신제품으로 내놓은 포도주. 마시면 기분이 좋아지며 취한다. 덩치가 커지는 부작용이 있음. 공격력 100%, Attack Speed 100% Movement Speed 50% 상승. 지속 15 seconds, 쿨타임 150초.";
-- anam
...
-- aub1 2
		t["A0IB"][18][1] = "*이 스킬을 사용할 경우 자신 주변 1200범위 내에 있는 Rare 등급 이하의 Units을 포섭합니다. 세이자는 포섭한 Units의 수에 따라 다음과 같은 효과를 얻습니다. 한번 포섭하면, 다시 이 스킬을 사용할때까지 효과가 지속됩니다. 120초의 Cooldown을 가집니다.\r\
...
＊|c0044BBFF[마력]|r - 50 : 초당 마력 5 회복, 공격당한 적의 체력을 무조건 22%로 만들고, 광기의 춤을 춰 대상 주변 500 범위의 적을 2.5 seconds간 기절시킵니다.";
-- atp1 1
...
-- atp1 1
		t["A0A9"][2][1] = "『환상향 공중신전』";
-- aub1 1
		t["A0A9"][3][1] = "＊|c002C62EA[마력]|r - 150 : 공격 시 마력 1 회복, 대상 위에 신앙심으로 건설된 공중신전을 내려꽂아 주변 600 범위의 적에게 전체 체력 5% + 400,000의 |c00379BFF마법 피해|r를 가합니다. 폭발 후 남은 신앙이 스와코에게 다시 깃들어 마력을 20~50% 회복합니다.";
-- anam
-- aart
...
-- aub1 1
		t["A0JF"][5][1] = "사용시 20 + 라운드 수*4,000큼의 골드를 획득합니다. Cooldown 60초";
-- anam
-- aart
...
*지속시간동안 마녀와 Rumia의 검이 공명하여 Rumia의 평타 공격이 500범위에 25%의 분산  True Damage로 적용됩니다.\r\
*어둠의 마녀의 지속시간이 끝나면 주변 900범위 적을 그림자로 끌고 갑니다. 체력이 50% 이하인 적에게 전체 체력의 10%에 해당하는 |c00AC59FF True Damage|r를 입힙니다.\r\
[보스 미적용]";
-- aart
...
*리카코가 10초간『마공학 핵』에 담긴 힘을 폭주시킵니다. 자신 주변 1000범위에 있는 적에게 2초마다 전체 체력의 0.8% + 80,000의 |c00FF6464 Physical Damage|r를 입힙니다. \r\
...
*|c002C62EA[마력]|r - 30 : 공격 시 마력 3 회복, 죽음을 퍼뜨려 자신 주변 600 범위의 적에게 전체 체력 0.4% + 250,000의 |c00379BFF마법 피해|r를 가합니다.";
-- anam
-- aart
...
-- atp1 31
-- aub1 2
		t["A0LD"][36][1] = "*|c002C62EA[마력]|r - 135 : 공격 시 마력 1 회복, 대상 주변 600 범위에 6번의 달빛을 퍼뜨립니다. 달빛은 70,000~100,000의 |c00379BFF마법 피해|r를 가합니다.";
-- aub1 3
-- aub1 4
-- aub1 5
-- aub1 6
...
＊|c00FF80FF[활력]|r - 10초 : 6초 동안 지속되는 맹독을 대상한테 주입해 1초마다 전체 체력 1% + 50,000(보스는 30%)의 |c00AC59FF절대 피해|r를 가하고 방어력을 45 감소시킵니다. 맹독은 중첩되지 않습니다.";
-- abuf 1
		t["A09D"][8][1] = "B035";
-- atp1 2
...
-- aub1 2
		t["A0LO"][13][1] = "목표 Normal Units을 랜덤한 Magic Units으로 바꿉니다. Cooldown 160초";
-- [A0LP]
-- aart
-- arac
-- anam
...
-겐지 할아범[Special]를 보유하고 있을 경우, 신사 진영 능력인『신령강림』의 Cooldown이 300초에서 250초로 감소합니다.";
-- aart
-- [A0LV]
-- ahky
-- atp1 1
...
-- aub1 1
		t["A0GS"][3][1] = "＊|c0044BBFF[마력]|r - 6 : 공격 시 마력 1 회복, 실체화한 악몽을 전방 1000거리까지 날려 닿은 적에게 66,000의 |c00379BFF마법 피해|r를 가합니다.";
-- anam
-- aart
-- atp1 2
-- atp1 3
...
-- aub1 1
		t["A0M5"][4][1] = "*코코로가 공격시 마나를 1씩 회복합니다. 마나가 165가 됐을때 코코로가 자신의 분신을 생성하여 가면무를 춥니다. 가면무는 총 10초간 지속되며, 2초마다 주변 1000범위의 적에게 125,000의 |c00FF6464 Physical Damage|r를 입힙니다. 가면무는 다음의 효과중 하나를 2초마다 하나씩 발동시킵니다.\r\
...
-- aub1 1
		t["A03J"][3][1] = "＊|c0044BBFF[마력]|r - 100 : 공격 시 마력 2 회복, Namazu가 격렬하게 철벅거려 자신주변 500 범위의 적에게 전체 체력 2% + 300,000의 |c00FF6464물리 피해|r를 가합니다.\r\
|c00FF712D[허영갑주]|r + 15";
-- anam
-- aart
...
-- aub1 1
		t["A01N"][3][1] = "＊|c002C62EA[마력]|r - 35 : 공격 시 마력 1 회복, 치명적인 독을 풀어 대상 주변 500 범위의 적에게 Current Health 1.25% + 145,000의 |c00FF6464물리 피해|r를 가하고 3초간 Movement Speed를 65% 감소시킵니다.";
-- aart
...
*시간 가속 버프의 지속시간 동안 사쿠야가 공격시 10% 확률로 대상 전체 체력의 10%를 감소시키고, 감소시킨 체력의 15%에 해당하는 |c00FF6464 Physical Damage|r를 주변 400범위 적에게 입힙니다.\r\
...
＊|c002C62EA[[마력]|r - 140 : 공격 시 마력 1 회복, 거대한 어둠의 구체를 만들고 폭발시켜 대상 주변 600 범위의 적에게 전체 체력 2.5% + 275,000의 |c00FF6464물리 피해|r를 가하고 5 seconds간 Movement Speed를 80% 감소시키며, 1.5 seconds간 기절시킨다.";
-- anam
-- aart
-- atp1 2
...
-- ahky
-- aub1 1
		t["A0JH"][7][1] = "10%의 확률로 나무를 1 획득합니다. Cooldown 60초";
-- arac
-- atp1 2
...
*피를 칼날로 만들어 대상 주변 350범위에 있는 적에게 [전체 체력의 3% + 950,000]의 |c00379BFF Magical Damage|r를 입히고, 받는  Magical Damage를 10초간 15% 증폭시킵니다.[수치가 같은  Magical Damage 증폭 효과와 함께 적용됩니다]\r\
*발동시 마나를 모두 회복합니다.\r\
[사용 효과]\r\
*대상 Unique Units을 흡혈하여 50초간 정지시킵니다. 정지 상태일때는 Combination 재료로 사용할 수 없으며, 어떠한 행동도 할 수 없습니다.[Unique Soul 추출은 가능합니다] 이미 정지한 Units은 흡혈할 수 없습니다.\r\
...
＊|c0044BBFF[마력]|r - 70 : 공격 시 마력 1~2 회복, 음양옥을 대상 위치에 던져 주변 350 범위의 적에게 전체 체력 1% + 350,000의 |c00FF6464물리 피해|r를 가하고 2.5 seconds간 기절시킵니다.";
-- anam
-- aart
-- atat
-- abuf 1
...
영부『몽상봉인』\r\
＊레이무의 공격은 전방의 적에게 피해를 가합니다.\r\
＊|c0044BBFF[마력]|r - 70 : 공격 시 마력 2~4 회복, 음양옥을 대상 위치에 던져 주변 350 범위의 적에게 전체 체력 2% + 700,000의 |c00FF6464물리 피해|r를 가하고 2.5 seconds간 기절시킵니다.";
-- atp1 3
		t["A0QY"][13][1] = "주부『명주암투』";
-- aub1 3
		t["A0QY"][14][1] = "＊|c0044BBFF[마력]|r - 70 : 공격 시 마력 1~2 회복, 음양옥을 대상 위치에 던져 주변 350 범위의 적에게 전체 체력 1% + 350,000의 |c00FF6464물리 피해|r를 가하고 2.5 seconds간 기절시킵니다.";
-- atar 3
-- aub1 4
-- [A0QZ]
-- aart
...
-- atp1 1
		t["A0CZ"][2][1] = "『마술사 메리』";
-- aub1 1
		t["A0CZ"][3][1] = "＊|c0044BBFF[마력]|r - 100 : 공격 시 마력 1 회복, 자신 주변 500 범위의 무작위 아군에게 신비한 경계를 들여다보는 힘을 부여합니다. 10초 동안 공격력이 45,000 증가하고 1초마다 마력을 2% 회복시킵니다.\r\
...
-- aub1 1
		t["A0SO"][2][1] = "＊|c0044BBFF[마력]|r - 130 : 대상에게 각인을 5 seconds 동안 새겨 대상 주변 450 범위의 적에게 0.5 seconds마다 전체 체력 0.2% + 50,000의 |c00379BFF마법 피해|r를 가합니다. 만약 각인된 대상이 사망한다면, 전체 체력 5.5% + 100,000의 |c00379BFF마법 피해|r를 가하고 자신의 마력을 25% 회복합니다.";
-- anam
-- aart
-- atar 1
-- [A0SP]
...
＊자신 주변 600 범위의 적 Movement Speed를 25% 감소시킵니다.\r\
＊|c0044BBFF[마력]|r - 100 : 공격 시 마력 1 회복합니다. 메디슨 기준으로 달콤한 독을 뿌려 자신 주변 600 범위의 적에게 Current Health 2% + 80,000의 |c00AC59FF절대 피해|r를 가하고 6초간 아군의 공격력을 80% 증가시킵니다.";
-- anam
-- abuf 1
		t["S00Y"][6][1] = "B07R";
-- aart
...
-- aub1 1
		t["A0UY"][4][1] = "＊[사용식 능력] : 환상향을 정화시켜 더러움을 없애고 완전무결한 땅으로 만듭니다. 자신 주변 700 범위의 적에게 Current Health 15%의 |c00AC59FF절대 피해|r를 가하고, 월인을 제외한 맵 전체의 자신 소유 Units을 5 seconds간 기절시킵니다. Cooldown 300초";
-- ahky
-- areq
-- Ncl6G1
		t["A0UY"][7][1] = "d";
