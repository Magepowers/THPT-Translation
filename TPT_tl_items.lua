...
-- utub
		t["penr"][3][1] = "|c000080FF그 시절 이야기를 하기에는 부끄러운데... - 야사카 카나코|r\r\
\r\
...
-- utub
		t["I02D"][5][1] = "고대 지식이 적혀있는 두루마리. 어떤 책을 좋아하는 요괴가 좋아할 거같은 책이다. 너무 낡은 책이라 가끔 할인을 해주기도 한다.(이 아이템을 구매할 경우 특수 유닛인 토키코를 얻을 수 있습니다.";
-- ides
-- uhot
-- icla
-- [I02E]
...
-- utub
		t["I00R"][5][1] = "진영을 지령전으로 선택합니다. 레이우지 우츠호[레전더리]의 조합이 가능해집니다.\r\
\r\
...
-- utub
		t["I00S"][5][1] = "진영을 요괴의 산으로 선택합니다. 또한 샤메이마루 아야[레전더리]의 조합이 가능해집니다.\r\
\r\
...
-- ides
		t["I01M"][2][1] = "해방된 원소들이 한데 모여 응집된 구슬입니다. 미마는 이 구슬을 지팡이에 넣고 사용하고 있습니다.\r\
\r\
...
-- utub
		t["I01P"][5][1] = "진영을 달의 도시로 선택합니다. 세이란[레전더리]의 조합이 가능해집니다.\r\
\r\
...
-- utub
		t["I01S"][5][1] = "진영을 휘침성으로 선택합니다. 스쿠나 신묘마루[레전더리]의 조합이 가능해집니다.\r\
\r\
...
-- utub
		t["I00A"][5][1] = "진영을 이름 없는 언덕으로 선택합니다. 메디슨 멜랑콜리[레전더리]의 조합이 가능해집니다.\r\
\r\
